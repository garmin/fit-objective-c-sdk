...
- (void)onMesg:(FITMessage*)message {
    ...
    switch ([message getNum]) {
        ...
        case FITMesgNumMetZone:
            ...
            break;
        case FITMesgNumTrainingSettings:
            [self.fitTrainingSettingsMesgDelegate onTrainingSettingsMesg:[[FITTrainingSettingsMesg alloc] initWithMessage:message]];
            break;
        ...
        case FITMesgNumTrainingFile:
            ...
            break;
        case FITMesgNumBattery:
            [self.fitBatteryMesgDelegate onBatteryMesg:[[FITBatteryMesg alloc] initWithMessage:message]];
            break;
        ...
        case FITMesgNumSleepAssessment:
            ...
            break;
        case FITMesgNumSleepDisruptionSeverityPeriod:
            [self.fitSleepDisruptionSeverityPeriodMesgDelegate onSleepDisruptionSeverityPeriodMesg:[[FITSleepDisruptionSeverityPeriodMesg alloc] initWithMessage:message]];
            break;
        case FITMesgNumSleepDisruptionOvernightSeverity:
            [self.fitSleepDisruptionOvernightSeverityMesgDelegate onSleepDisruptionOvernightSeverityMesg:[[FITSleepDisruptionOvernightSeverityMesg alloc] initWithMessage:message]];
            break;
        case FITMesgNumNapEvent:
            [self.fitNapEventMesgDelegate onNapEventMesg:[[FITNapEventMesg alloc] initWithMessage:message]];
            break;
