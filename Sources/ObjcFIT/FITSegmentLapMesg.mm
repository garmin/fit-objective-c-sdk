...
- (FITUInt16)getMetabolicCalories {
    return ([super getFieldUINT16ValueForField:88 forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD]);
}

- (void)setMetabolicCalories:(FITUInt16)metabolicCalories {
    [super setFieldUINT16ValueForField:88 andValue:(metabolicCalories) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
