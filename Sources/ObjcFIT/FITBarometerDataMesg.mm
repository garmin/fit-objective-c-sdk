...
- (FITFloat32)getEnhancedAltitudeforIndex:(uint8_t)index {
    return ([super getFieldFLOAT32ValueForField:3 forIndex:index andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD]);
}

- (void)setEnhancedAltitude:(FITFloat32)enhancedAltitude forIndex:(uint8_t)index {
    [super setFieldFLOAT32ValueForField:3 andValue:(enhancedAltitude) forIndex:index andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
