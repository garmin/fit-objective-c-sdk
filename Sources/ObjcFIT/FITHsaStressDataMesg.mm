...
@implementation FITHsaStressDataMesg

- (instancetype)init {
    self = [super initWithFitMesgIndex:fit::Profile::MESG_HSA_STRESS_DATA];
...
- (void)setStressLevel:(FITSInt8)stressLevel forIndex:(uint8_t)index {
    [super setFieldSINT8ValueForField:1 andValue:(stressLevel) forIndex:index andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
