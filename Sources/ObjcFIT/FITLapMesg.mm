...
- (BOOL)isTotalPushesValid
{
    ...
    if(![super canField:10 supportSubField:(FITUInt16)FITLapMesgTotalCyclesFieldTotalPushesSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITLapMesgTotalCyclesFieldTotalPushesSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITUInt32)getTotalPushes
{
    return ([super getFieldUINT32ValueForField:10 forIndex:0 andSubFieldIndex:FITLapMesgTotalCyclesFieldTotalPushesSubField]);
}

- (void)setTotalPushes:(FITUInt32)totalPushes
{
    [super setFieldUINT32ValueForField:10 andValue:(totalPushes) forIndex:0 andSubFieldIndex:FITLapMesgTotalCyclesFieldTotalPushesSubField];
} 
...
- (BOOL)isAvgSwimmingCadenceValid
{
    ...
    if(![super canField:17 supportSubField:(FITUInt16)FITLapMesgAvgCadenceFieldAvgSwimmingCadenceSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITLapMesgAvgCadenceFieldAvgSwimmingCadenceSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITUInt8)getAvgSwimmingCadence
{
    return ([super getFieldUINT8ValueForField:17 forIndex:0 andSubFieldIndex:FITLapMesgAvgCadenceFieldAvgSwimmingCadenceSubField]);
}

- (void)setAvgSwimmingCadence:(FITUInt8)avgSwimmingCadence
{
    [super setFieldUINT8ValueForField:17 andValue:(avgSwimmingCadence) forIndex:0 andSubFieldIndex:FITLapMesgAvgCadenceFieldAvgSwimmingCadenceSubField];
} 
...
- (BOOL)isAvgPaddlesportCadenceValid
{
    ...
    if(![super canField:17 supportSubField:(FITUInt16)FITLapMesgAvgCadenceFieldAvgPaddlesportCadenceSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITLapMesgAvgCadenceFieldAvgPaddlesportCadenceSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITUInt8)getAvgPaddlesportCadence
{
    return ([super getFieldUINT8ValueForField:17 forIndex:0 andSubFieldIndex:FITLapMesgAvgCadenceFieldAvgPaddlesportCadenceSubField]);
}

- (void)setAvgPaddlesportCadence:(FITUInt8)avgPaddlesportCadence
{
    [super setFieldUINT8ValueForField:17 andValue:(avgPaddlesportCadence) forIndex:0 andSubFieldIndex:FITLapMesgAvgCadenceFieldAvgPaddlesportCadenceSubField];
} 
...
- (BOOL)isAvgPushCadenceValid
{
    ...
    if(![super canField:17 supportSubField:(FITUInt16)FITLapMesgAvgCadenceFieldAvgPushCadenceSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITLapMesgAvgCadenceFieldAvgPushCadenceSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITUInt8)getAvgPushCadence
{
    return ([super getFieldUINT8ValueForField:17 forIndex:0 andSubFieldIndex:FITLapMesgAvgCadenceFieldAvgPushCadenceSubField]);
}

- (void)setAvgPushCadence:(FITUInt8)avgPushCadence
{
    [super setFieldUINT8ValueForField:17 andValue:(avgPushCadence) forIndex:0 andSubFieldIndex:FITLapMesgAvgCadenceFieldAvgPushCadenceSubField];
} 
...
- (BOOL)isMaxSwimmingCadenceValid
{
    ...
    if(![super canField:18 supportSubField:(FITUInt16)FITLapMesgMaxCadenceFieldMaxSwimmingCadenceSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITLapMesgMaxCadenceFieldMaxSwimmingCadenceSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITUInt8)getMaxSwimmingCadence
{
    return ([super getFieldUINT8ValueForField:18 forIndex:0 andSubFieldIndex:FITLapMesgMaxCadenceFieldMaxSwimmingCadenceSubField]);
}

- (void)setMaxSwimmingCadence:(FITUInt8)maxSwimmingCadence
{
    [super setFieldUINT8ValueForField:18 andValue:(maxSwimmingCadence) forIndex:0 andSubFieldIndex:FITLapMesgMaxCadenceFieldMaxSwimmingCadenceSubField];
} 
...
- (BOOL)isMaxPaddlesportCadenceValid
{
    ...
    if(![super canField:18 supportSubField:(FITUInt16)FITLapMesgMaxCadenceFieldMaxPaddlesportCadenceSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITLapMesgMaxCadenceFieldMaxPaddlesportCadenceSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITUInt8)getMaxPaddlesportCadence
{
    return ([super getFieldUINT8ValueForField:18 forIndex:0 andSubFieldIndex:FITLapMesgMaxCadenceFieldMaxPaddlesportCadenceSubField]);
}

- (void)setMaxPaddlesportCadence:(FITUInt8)maxPaddlesportCadence
{
    [super setFieldUINT8ValueForField:18 andValue:(maxPaddlesportCadence) forIndex:0 andSubFieldIndex:FITLapMesgMaxCadenceFieldMaxPaddlesportCadenceSubField];
} 
...
- (BOOL)isMaxPushCadenceValid
{
    ...
    if(![super canField:18 supportSubField:(FITUInt16)FITLapMesgMaxCadenceFieldMaxPushCadenceSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITLapMesgMaxCadenceFieldMaxPushCadenceSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITUInt8)getMaxPushCadence
{
    return ([super getFieldUINT8ValueForField:18 forIndex:0 andSubFieldIndex:FITLapMesgMaxCadenceFieldMaxPushCadenceSubField]);
}

- (void)setMaxPushCadence:(FITUInt8)maxPushCadence
{
    [super setFieldUINT8ValueForField:18 andValue:(maxPushCadence) forIndex:0 andSubFieldIndex:FITLapMesgMaxCadenceFieldMaxPushCadenceSubField];
} 
...
- (void)setNecLat:(FITSInt32)necLat {
    [super setFieldSINT32ValueForField:27 andValue:(necLat) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
...
- (void)setNecLong:(FITSInt32)necLong {
    [super setFieldSINT32ValueForField:28 andValue:(necLong) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
...
- (void)setSwcLat:(FITSInt32)swcLat {
    [super setFieldSINT32ValueForField:29 andValue:(swcLat) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
...
- (void)setSwcLong:(FITSInt32)swcLong {
    [super setFieldSINT32ValueForField:30 andValue:(swcLong) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
...
- (FITFloat32)getActiveTime {
    return ([super getFieldFLOAT32ValueForField:70 forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD]);
}

- (void)setActiveTime:(FITFloat32)activeTime {
    [super setFieldFLOAT32ValueForField:70 andValue:(activeTime) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
...
- (FITUInt16)getAvgSwolf {
    return ([super getFieldUINT16ValueForField:73 forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD]);
}

- (void)setAvgSwolf:(FITUInt16)avgSwolf {
    [super setFieldUINT16ValueForField:73 andValue:(avgSwolf) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
...
- (void)setAvgStrokesPerLength:(FITFloat32)avgStrokesPerLength {
    [super setFieldFLOAT32ValueForField:90 andValue:(avgStrokesPerLength) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
...
- (FITUInt16)getFrontGearShiftCount {
    return ([super getFieldUINT16ValueForField:96 forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD]);
}

- (void)setFrontGearShiftCount:(FITUInt16)frontGearShiftCount {
    [super setFieldUINT16ValueForField:96 andValue:(frontGearShiftCount) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
...
- (FITUInt16)getRearGearShiftCount {
    return ([super getFieldUINT16ValueForField:97 forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD]);
}

- (void)setRearGearShiftCount:(FITUInt16)rearGearShiftCount {
    [super setFieldUINT16ValueForField:97 andValue:(rearGearShiftCount) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
...
- (void)setMetabolicCalories:(FITUInt16)metabolicCalories {
    [super setFieldUINT16ValueForField:155 andValue:(metabolicCalories) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
...
- (BOOL)isAvgGradeAdjustedSpeedValid {
	const fit::Field* field = [super getField:161];
	if( FIT_NULL == field ) {
		return FALSE;
	}
...
- (FITFloat32)getAvgGradeAdjustedSpeed {
    return ([super getFieldFLOAT32ValueForField:161 forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD]);
}

- (void)setAvgGradeAdjustedSpeed:(FITFloat32)avgGradeAdjustedSpeed {
    [super setFieldFLOAT32ValueForField:161 andValue:(avgGradeAdjustedSpeed) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
