...
@implementation FITHsaStepDataMesg

- (instancetype)init {
    self = [super initWithFitMesgIndex:fit::Profile::MESG_HSA_STEP_DATA];
...
- (void)setSteps:(FITUInt32)steps forIndex:(uint8_t)index {
    [super setFieldUINT32ValueForField:1 andValue:(steps) forIndex:index andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
