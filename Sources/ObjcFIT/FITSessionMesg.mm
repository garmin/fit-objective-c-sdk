...
- (BOOL)isTotalRepsValid
{
    ...
    if(![super canField:10 supportSubField:(FITUInt16)FITSessionMesgTotalCyclesFieldTotalRepsSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITSessionMesgTotalCyclesFieldTotalRepsSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITUInt32)getTotalReps
{
    return ([super getFieldUINT32ValueForField:10 forIndex:0 andSubFieldIndex:FITSessionMesgTotalCyclesFieldTotalRepsSubField]);
}

- (void)setTotalReps:(FITUInt32)totalReps
{
    [super setFieldUINT32ValueForField:10 andValue:(totalReps) forIndex:0 andSubFieldIndex:FITSessionMesgTotalCyclesFieldTotalRepsSubField];
} 
...
- (BOOL)isTotalPushesValid
{
    ...
    if(![super canField:10 supportSubField:(FITUInt16)FITSessionMesgTotalCyclesFieldTotalPushesSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITSessionMesgTotalCyclesFieldTotalPushesSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITUInt32)getTotalPushes
{
    return ([super getFieldUINT32ValueForField:10 forIndex:0 andSubFieldIndex:FITSessionMesgTotalCyclesFieldTotalPushesSubField]);
}

- (void)setTotalPushes:(FITUInt32)totalPushes
{
    [super setFieldUINT32ValueForField:10 andValue:(totalPushes) forIndex:0 andSubFieldIndex:FITSessionMesgTotalCyclesFieldTotalPushesSubField];
} 
...
- (BOOL)isAvgSwimmingCadenceValid
{
    ...
    if(![super canField:18 supportSubField:(FITUInt16)FITSessionMesgAvgCadenceFieldAvgSwimmingCadenceSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITSessionMesgAvgCadenceFieldAvgSwimmingCadenceSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITUInt8)getAvgSwimmingCadence
{
    return ([super getFieldUINT8ValueForField:18 forIndex:0 andSubFieldIndex:FITSessionMesgAvgCadenceFieldAvgSwimmingCadenceSubField]);
}

- (void)setAvgSwimmingCadence:(FITUInt8)avgSwimmingCadence
{
    [super setFieldUINT8ValueForField:18 andValue:(avgSwimmingCadence) forIndex:0 andSubFieldIndex:FITSessionMesgAvgCadenceFieldAvgSwimmingCadenceSubField];
} 
...
- (BOOL)isAvgPaddlesportCadenceValid
{
    ...
    if(![super canField:18 supportSubField:(FITUInt16)FITSessionMesgAvgCadenceFieldAvgPaddlesportCadenceSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITSessionMesgAvgCadenceFieldAvgPaddlesportCadenceSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITUInt8)getAvgPaddlesportCadence
{
    return ([super getFieldUINT8ValueForField:18 forIndex:0 andSubFieldIndex:FITSessionMesgAvgCadenceFieldAvgPaddlesportCadenceSubField]);
}

- (void)setAvgPaddlesportCadence:(FITUInt8)avgPaddlesportCadence
{
    [super setFieldUINT8ValueForField:18 andValue:(avgPaddlesportCadence) forIndex:0 andSubFieldIndex:FITSessionMesgAvgCadenceFieldAvgPaddlesportCadenceSubField];
} 
...
- (BOOL)isAvgPushCadenceValid
{
    ...
    if(![super canField:18 supportSubField:(FITUInt16)FITSessionMesgAvgCadenceFieldAvgPushCadenceSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITSessionMesgAvgCadenceFieldAvgPushCadenceSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITUInt8)getAvgPushCadence
{
    return ([super getFieldUINT8ValueForField:18 forIndex:0 andSubFieldIndex:FITSessionMesgAvgCadenceFieldAvgPushCadenceSubField]);
}

- (void)setAvgPushCadence:(FITUInt8)avgPushCadence
{
    [super setFieldUINT8ValueForField:18 andValue:(avgPushCadence) forIndex:0 andSubFieldIndex:FITSessionMesgAvgCadenceFieldAvgPushCadenceSubField];
} 
...
- (BOOL)isMaxSwimmingCadenceValid
{
    ...
    if(![super canField:19 supportSubField:(FITUInt16)FITSessionMesgMaxCadenceFieldMaxSwimmingCadenceSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITSessionMesgMaxCadenceFieldMaxSwimmingCadenceSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITUInt8)getMaxSwimmingCadence
{
    return ([super getFieldUINT8ValueForField:19 forIndex:0 andSubFieldIndex:FITSessionMesgMaxCadenceFieldMaxSwimmingCadenceSubField]);
}

- (void)setMaxSwimmingCadence:(FITUInt8)maxSwimmingCadence
{
    [super setFieldUINT8ValueForField:19 andValue:(maxSwimmingCadence) forIndex:0 andSubFieldIndex:FITSessionMesgMaxCadenceFieldMaxSwimmingCadenceSubField];
} 
...
- (BOOL)isMaxPaddlesportCadenceValid
{
    ...
    if(![super canField:19 supportSubField:(FITUInt16)FITSessionMesgMaxCadenceFieldMaxPaddlesportCadenceSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITSessionMesgMaxCadenceFieldMaxPaddlesportCadenceSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITUInt8)getMaxPaddlesportCadence
{
    return ([super getFieldUINT8ValueForField:19 forIndex:0 andSubFieldIndex:FITSessionMesgMaxCadenceFieldMaxPaddlesportCadenceSubField]);
}

- (void)setMaxPaddlesportCadence:(FITUInt8)maxPaddlesportCadence
{
    [super setFieldUINT8ValueForField:19 andValue:(maxPaddlesportCadence) forIndex:0 andSubFieldIndex:FITSessionMesgMaxCadenceFieldMaxPaddlesportCadenceSubField];
} 
...
- (BOOL)isMaxPushCadenceValid
{
    ...
    if(![super canField:19 supportSubField:(FITUInt16)FITSessionMesgMaxCadenceFieldMaxPushCadenceSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITSessionMesgMaxCadenceFieldMaxPushCadenceSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITUInt8)getMaxPushCadence
{
    return ([super getFieldUINT8ValueForField:19 forIndex:0 andSubFieldIndex:FITSessionMesgMaxCadenceFieldMaxPushCadenceSubField]);
}

- (void)setMaxPushCadence:(FITUInt8)maxPushCadence
{
    [super setFieldUINT8ValueForField:19 andValue:(maxPushCadence) forIndex:0 andSubFieldIndex:FITSessionMesgMaxCadenceFieldMaxPushCadenceSubField];
} 
...
- (void)setAvgStrokesPerLength:(FITFloat32)avgStrokesPerLength {
    [super setFieldFLOAT32ValueForField:79 andValue:(avgStrokesPerLength) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
...
- (FITUInt16)getAvgSwolf {
    return ([super getFieldUINT16ValueForField:80 forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD]);
}

- (void)setAvgSwolf:(FITUInt16)avgSwolf {
    [super setFieldUINT16ValueForField:80 andValue:(avgSwolf) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
...
- (FITUInt16)getNumSegmentLaps {
    return ([super getFieldUINT16ValueForField:106 forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD]);
}

- (void)setNumSegmentLaps:(FITUInt16)numSegmentLaps {
    [super setFieldUINT16ValueForField:106 andValue:(numSegmentLaps) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
...
- (FITUInt16)getFrontGearShiftCount {
    return ([super getFieldUINT16ValueForField:107 forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD]);
}

- (void)setFrontGearShiftCount:(FITUInt16)frontGearShiftCount {
    [super setFieldUINT16ValueForField:107 andValue:(frontGearShiftCount) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
...
- (FITUInt16)getRearGearShiftCount {
    return ([super getFieldUINT16ValueForField:108 forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD]);
}

- (void)setRearGearShiftCount:(FITUInt16)rearGearShiftCount {
    [super setFieldUINT16ValueForField:108 andValue:(rearGearShiftCount) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
...
- (void)setMetabolicCalories:(FITUInt16)metabolicCalories {
    [super setFieldUINT16ValueForField:196 andValue:(metabolicCalories) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
...
- (BOOL)isAvgGradeAdjustedSpeedValid {
	const fit::Field* field = [super getField:211];
	if( FIT_NULL == field ) {
		return FALSE;
	}
...
- (FITFloat32)getAvgGradeAdjustedSpeed {
    return ([super getFieldFLOAT32ValueForField:211 forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD]);
}

- (void)setAvgGradeAdjustedSpeed:(FITFloat32)avgGradeAdjustedSpeed {
    [super setFieldFLOAT32ValueForField:211 andValue:(avgGradeAdjustedSpeed) forIndex:0 andSubFieldIndex:FIT_SUBFIELD_INDEX_MAIN_FIELD];
} 
