...
public class FITListener: NSObject, FITMesgDelegate {
    ...
    public func onMesg(_ mesg: FITMessage) {
        ...
        case FITMesgNumTrainingSettings:
            fitMessages.trainingSettingsMesgs.append(FITTrainingSettingsMesg(message: mesg));
            break;
        ...
        case FITMesgNumBattery:
            fitMessages.batteryMesgs.append(FITBatteryMesg(message: mesg));
            break;
        ...
        case FITMesgNumSleepDisruptionSeverityPeriod:
            fitMessages.sleepDisruptionSeverityPeriodMesgs.append(FITSleepDisruptionSeverityPeriodMesg(message: mesg));
            break;
        case FITMesgNumSleepDisruptionOvernightSeverity:
            fitMessages.sleepDisruptionOvernightSeverityMesgs.append(FITSleepDisruptionOvernightSeverityMesg(message: mesg));
            break;
        case FITMesgNumNapEvent:
            fitMessages.napEventMesgs.append(FITNapEventMesg(message: mesg));
            break;
