...
public:
    ...
    FIT_UINT64 GetBitsValue64(const FIT_UINT16 offset, const FIT_UINT8 bits) const;
    FIT_SINT64 GetBitsSignedValue64(const FIT_UINT16 offset, const FIT_UINT8 bits) const;
...
private:
    ...
    template <typename T>
    T GetBitsValueT(const FIT_UINT16 offset, const FIT_UINT8 bits) const;

    template <typename TSigned>
    TSigned GetBitsSignedValueT(const FIT_UINT16 offset, const FIT_UINT8 bits) const;
