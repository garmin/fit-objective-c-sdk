...
#define FIT_MESG_NUM_BATTERY                                                     ((FIT_MESG_NUM)104)
...
#define FIT_MESG_NUM_NAP_EVENT                                                   ((FIT_MESG_NUM)412)
...
#define FIT_SPORT_SHOOTING                                                       ((FIT_SPORT)56) // Sport Shooting bits, set here for sport_bits alignment
#define FIT_SPORT_WINTER_SPORT                                                   ((FIT_SPORT)58)
#define FIT_SPORT_GRINDING                                                       ((FIT_SPORT)59) // Sailing position, operating manual winches to power boat controls
#define FIT_SPORT_HIIT                                                           ((FIT_SPORT)62)
#define FIT_SPORT_VIDEO_GAMING                                                   ((FIT_SPORT)63)
...
#define FIT_SPORT_PARA_SPORT                                                     ((FIT_SPORT)68)
#define FIT_SPORT_DISC_GOLF                                                      ((FIT_SPORT)69)
#define FIT_SPORT_TEAM_SPORT                                                     ((FIT_SPORT)70)
...
#define FIT_SPORT_WATER_SPORT                                                    ((FIT_SPORT)78)
#define FIT_SPORT_ARCHERY                                                        ((FIT_SPORT)79)
#define FIT_SPORT_MIXED_MARTIAL_ARTS                                             ((FIT_SPORT)80)
#define FIT_SPORT_MOTOR_SPORTS                                                   ((FIT_SPORT)81)
#define FIT_SPORT_SNORKELING                                                     ((FIT_SPORT)82)
#define FIT_SPORT_DANCE                                                          ((FIT_SPORT)83)
#define FIT_SPORT_JUMP_ROPE                                                      ((FIT_SPORT)84)
#define FIT_SPORT_POOL_APNEA                                                     ((FIT_SPORT)85)
#define FIT_SPORT_MOBILITY                                                       ((FIT_SPORT)86)
#define FIT_SPORT_GEOCACHING                                                     ((FIT_SPORT)87)
#define FIT_SPORT_CANOEING                                                       ((FIT_SPORT)88)
...
#define FIT_SUB_SPORT_CCR_DIVING                                                 ((FIT_SUB_SPORT)63) // Diving w/ closed circuit rebreather
#define FIT_SUB_SPORT_SAIL_RACE                                                  ((FIT_SUB_SPORT)65) // Sailing
#define FIT_SUB_SPORT_EXPEDITION                                                 ((FIT_SUB_SPORT)66) // Generic
...
#define FIT_SUB_SPORT_INDOOR_GRINDING                                            ((FIT_SUB_SPORT)71) // Sailing position, operating manual winches to power boat controls
#define FIT_SUB_SPORT_HUNTING_WITH_DOGS                                          ((FIT_SUB_SPORT)72) // Hunting
...
#define FIT_SUB_SPORT_ESPORT                                                     ((FIT_SUB_SPORT)77) // Video Gaming, Cycling, etc.
#define FIT_SUB_SPORT_TRIATHLON                                                  ((FIT_SUB_SPORT)78) // Multisport
#define FIT_SUB_SPORT_DUATHLON                                                   ((FIT_SUB_SPORT)79) // Multisport
#define FIT_SUB_SPORT_BRICK                                                      ((FIT_SUB_SPORT)80) // Multisport
#define FIT_SUB_SPORT_SWIM_RUN                                                   ((FIT_SUB_SPORT)81) // Multisport
#define FIT_SUB_SPORT_ADVENTURE_RACE                                             ((FIT_SUB_SPORT)82) // Multisport/Running
#define FIT_SUB_SPORT_TRUCKER_WORKOUT                                            ((FIT_SUB_SPORT)83) // DEZL trucker workout training sport
...
#define FIT_SUB_SPORT_FIELD                                                      ((FIT_SUB_SPORT)90) // Hockey
#define FIT_SUB_SPORT_ICE                                                        ((FIT_SUB_SPORT)91) // Hockey
#define FIT_SUB_SPORT_ULTIMATE                                                   ((FIT_SUB_SPORT)92) // Disc
#define FIT_SUB_SPORT_PLATFORM                                                   ((FIT_SUB_SPORT)93) // Racket
#define FIT_SUB_SPORT_SQUASH                                                     ((FIT_SUB_SPORT)94) // Racket
#define FIT_SUB_SPORT_BADMINTON                                                  ((FIT_SUB_SPORT)95) // Racket
#define FIT_SUB_SPORT_RACQUETBALL                                                ((FIT_SUB_SPORT)96) // Racket
#define FIT_SUB_SPORT_TABLE_TENNIS                                               ((FIT_SUB_SPORT)97) // Racket
#define FIT_SUB_SPORT_OVERLAND                                                   ((FIT_SUB_SPORT)98)
#define FIT_SUB_SPORT_TROLLING_MOTOR                                             ((FIT_SUB_SPORT)99) // Generic
...
#define FIT_SUB_SPORT_DYNAMIC_APNEA                                              ((FIT_SUB_SPORT)121)
#define FIT_SUB_SPORT_ENDURO                                                     ((FIT_SUB_SPORT)123) // Cycling
#define FIT_SUB_SPORT_RUCKING                                                    ((FIT_SUB_SPORT)124) // Hiking
#define FIT_SUB_SPORT_RALLY                                                      ((FIT_SUB_SPORT)125) // Motor sports
#define FIT_SUB_SPORT_POOL_TRIATHLON                                             ((FIT_SUB_SPORT)126) // Multisport
#define FIT_SUB_SPORT_E_BIKE_ENDURO                                              ((FIT_SUB_SPORT)127) // Cycling
...
#define FIT_MANUFACTURER_ZEPP                                                    ((FIT_MANUFACTURER)339)
#define FIT_MANUFACTURER_PELOTON                                                 ((FIT_MANUFACTURER)340)
#define FIT_MANUFACTURER_CARV                                                    ((FIT_MANUFACTURER)341)
#define FIT_MANUFACTURER_TISSOT                                                  ((FIT_MANUFACTURER)342)
#define FIT_MANUFACTURER_REAL_VELO                                               ((FIT_MANUFACTURER)345)
#define FIT_MANUFACTURER_WETECH                                                  ((FIT_MANUFACTURER)346)
#define FIT_MANUFACTURER_JESPR                                                   ((FIT_MANUFACTURER)347)
#define FIT_MANUFACTURER_HUAWEI                                                  ((FIT_MANUFACTURER)348)
#define FIT_MANUFACTURER_GOTOES                                                  ((FIT_MANUFACTURER)349)
#define FIT_MANUFACTURER_CADENCE_APP                                             ((FIT_MANUFACTURER)350)
#define FIT_MANUFACTURER_UNA_WATCH                                               ((FIT_MANUFACTURER)351)
#define FIT_MANUFACTURER_TYMEWEAR                                                ((FIT_MANUFACTURER)352)
#define FIT_MANUFACTURER_EXPOSURE_LIGHTS                                         ((FIT_MANUFACTURER)353)
#define FIT_MANUFACTURER_FORTO_CYCLING                                           ((FIT_MANUFACTURER)354)
#define FIT_MANUFACTURER_ACTIGRAPHCORP                                           ((FIT_MANUFACTURER)5759)
#define FIT_MANUFACTURER_COUNT                                                   247
...
#define FIT_GARMIN_PRODUCT_FR970                                                 ((FIT_GARMIN_PRODUCT)4565)
#define FIT_GARMIN_PRODUCT_FR570_LARGE                                           ((FIT_GARMIN_PRODUCT)4570)
#define FIT_GARMIN_PRODUCT_FR570_SMALL                                           ((FIT_GARMIN_PRODUCT)4574)
...
#define FIT_GARMIN_PRODUCT_FENIX7_PRO_SOLAR_NO_WIFI                              ((FIT_GARMIN_PRODUCT)4595)
...
#define FIT_GARMIN_PRODUCT_FR170_MUSIC                                           ((FIT_GARMIN_PRODUCT)4814)
#define FIT_GARMIN_PRODUCT_FR170                                                 ((FIT_GARMIN_PRODUCT)4815)
#define FIT_GARMIN_PRODUCT_APPROACH_J1                                           ((FIT_GARMIN_PRODUCT)4825)
#define FIT_GARMIN_PRODUCT_D2_MACH2                                              ((FIT_GARMIN_PRODUCT)4879)
#define FIT_GARMIN_PRODUCT_FR70_2026                                             ((FIT_GARMIN_PRODUCT)4916)
#define FIT_GARMIN_PRODUCT_FENIX9_PRO_43MM                                       ((FIT_GARMIN_PRODUCT)4952)
#define FIT_GARMIN_PRODUCT_FENIX9_PRO_47MM                                       ((FIT_GARMIN_PRODUCT)4953)
#define FIT_GARMIN_PRODUCT_FENIX9_PRO_51MM                                       ((FIT_GARMIN_PRODUCT)4954)
#define FIT_GARMIN_PRODUCT_FENIX9_PRO_SOLAR_47MM                                 ((FIT_GARMIN_PRODUCT)4955)
#define FIT_GARMIN_PRODUCT_FENIX9_PRO_SOLAR_51MM                                 ((FIT_GARMIN_PRODUCT)4956)
#define FIT_GARMIN_PRODUCT_FENIX9_43MM                                           ((FIT_GARMIN_PRODUCT)5133)
#define FIT_GARMIN_PRODUCT_FENIX9                                                ((FIT_GARMIN_PRODUCT)5134) // 47mm & 57mm
...
#define FIT_GARMIN_PRODUCT_CIRQA_SMART_BAND                                      ((FIT_GARMIN_PRODUCT)5019)
#define FIT_GARMIN_PRODUCT_D2_MACH2_PRO                                          ((FIT_GARMIN_PRODUCT)5056)
...
#define FIT_GARMIN_PRODUCT_TRAINING_PEAKS_VIRTUAL_IOS                            ((FIT_GARMIN_PRODUCT)30059)
#define FIT_GARMIN_PRODUCT_TRAINING_PEAKS_VIRTUAL_ANDROID                        ((FIT_GARMIN_PRODUCT)30060)
#define FIT_GARMIN_PRODUCT_TRAINING_PEAKS_VIRTUAL_WINDOWS                        ((FIT_GARMIN_PRODUCT)30061)
#define FIT_GARMIN_PRODUCT_TRAINING_PEAKS_VIRTUAL_MAC_OS                         ((FIT_GARMIN_PRODUCT)30062)
#define FIT_GARMIN_PRODUCT_TRAINING_PEAKS_VIRTUAL_APPLE_TV                       ((FIT_GARMIN_PRODUCT)30063)
...
#define FIT_GARMIN_PRODUCT_COUNT                                                 496
...
#define FIT_ACTIVITY_TYPE_WHEELCHAIR_PUSHING                                     ((FIT_ACTIVITY_TYPE)13)
#define FIT_ACTIVITY_TYPE_ALL                                                    ((FIT_ACTIVITY_TYPE)254) // All is for goals only to include all sports.
#define FIT_ACTIVITY_TYPE_COUNT                                                  10
...
typedef FIT_ENUM FIT_CLIMB_GRADING_SCALE;
#define FIT_CLIMB_GRADING_SCALE_INVALID                                          FIT_ENUM_INVALID
#define FIT_CLIMB_GRADING_SCALE_YDS                                              ((FIT_CLIMB_GRADING_SCALE)0)
#define FIT_CLIMB_GRADING_SCALE_UIAA                                             ((FIT_CLIMB_GRADING_SCALE)1)
#define FIT_CLIMB_GRADING_SCALE_FRENCH                                           ((FIT_CLIMB_GRADING_SCALE)2)
#define FIT_CLIMB_GRADING_SCALE_BRITISH_ADJECTIVAL                               ((FIT_CLIMB_GRADING_SCALE)3)
#define FIT_CLIMB_GRADING_SCALE_BRITISH_TECHNICAL                                ((FIT_CLIMB_GRADING_SCALE)4)
#define FIT_CLIMB_GRADING_SCALE_EWBANK                                           ((FIT_CLIMB_GRADING_SCALE)5)
#define FIT_CLIMB_GRADING_SCALE_BRAZILIAN                                        ((FIT_CLIMB_GRADING_SCALE)6)
#define FIT_CLIMB_GRADING_SCALE_SAXON                                            ((FIT_CLIMB_GRADING_SCALE)7)
#define FIT_CLIMB_GRADING_SCALE_VERMIN                                           ((FIT_CLIMB_GRADING_SCALE)8)
#define FIT_CLIMB_GRADING_SCALE_FONT                                             ((FIT_CLIMB_GRADING_SCALE)9)
#define FIT_CLIMB_GRADING_SCALE_DANKYU                                           ((FIT_CLIMB_GRADING_SCALE)10)
#define FIT_CLIMB_GRADING_SCALE_YDS_PM                                           ((FIT_CLIMB_GRADING_SCALE)11) // YDS Plus Minus Grading Scale
#define FIT_CLIMB_GRADING_SCALE_COUNT                                            12

typedef FIT_ENUM FIT_YDS_GRADING_SCALE;
#define FIT_YDS_GRADING_SCALE_INVALID                                            FIT_ENUM_INVALID
#define FIT_YDS_GRADING_SCALE_5_1                                                ((FIT_YDS_GRADING_SCALE)0) // 5.1
#define FIT_YDS_GRADING_SCALE_5_2                                                ((FIT_YDS_GRADING_SCALE)1) // 5.2
#define FIT_YDS_GRADING_SCALE_5_3                                                ((FIT_YDS_GRADING_SCALE)2) // 5.3
#define FIT_YDS_GRADING_SCALE_5_4                                                ((FIT_YDS_GRADING_SCALE)3) // 5.4
#define FIT_YDS_GRADING_SCALE_5_5                                                ((FIT_YDS_GRADING_SCALE)4) // 5.5
#define FIT_YDS_GRADING_SCALE_5_6                                                ((FIT_YDS_GRADING_SCALE)5) // 5.6
#define FIT_YDS_GRADING_SCALE_5_7                                                ((FIT_YDS_GRADING_SCALE)6) // 5.7
#define FIT_YDS_GRADING_SCALE_5_8                                                ((FIT_YDS_GRADING_SCALE)7) // 5.8
#define FIT_YDS_GRADING_SCALE_5_9                                                ((FIT_YDS_GRADING_SCALE)8) // 5.9
#define FIT_YDS_GRADING_SCALE_5_10                                               ((FIT_YDS_GRADING_SCALE)9) // 5.1
#define FIT_YDS_GRADING_SCALE_5_10A                                              ((FIT_YDS_GRADING_SCALE)10) // 5.10a
#define FIT_YDS_GRADING_SCALE_5_10B                                              ((FIT_YDS_GRADING_SCALE)11) // 5.10b
#define FIT_YDS_GRADING_SCALE_5_10C                                              ((FIT_YDS_GRADING_SCALE)12) // 5.10c
#define FIT_YDS_GRADING_SCALE_5_10D                                              ((FIT_YDS_GRADING_SCALE)13) // 5.10d
#define FIT_YDS_GRADING_SCALE_5_11                                               ((FIT_YDS_GRADING_SCALE)14) // 5.11
#define FIT_YDS_GRADING_SCALE_5_11A                                              ((FIT_YDS_GRADING_SCALE)15) // 5.11a
#define FIT_YDS_GRADING_SCALE_5_11B                                              ((FIT_YDS_GRADING_SCALE)16) // 5.11b
#define FIT_YDS_GRADING_SCALE_5_11C                                              ((FIT_YDS_GRADING_SCALE)17) // 5.11c
#define FIT_YDS_GRADING_SCALE_5_11D                                              ((FIT_YDS_GRADING_SCALE)18) // 5.11d
#define FIT_YDS_GRADING_SCALE_5_12                                               ((FIT_YDS_GRADING_SCALE)19) // 5.12
#define FIT_YDS_GRADING_SCALE_5_12A                                              ((FIT_YDS_GRADING_SCALE)20) // 5.12a
#define FIT_YDS_GRADING_SCALE_5_12B                                              ((FIT_YDS_GRADING_SCALE)21) // 5.12b
#define FIT_YDS_GRADING_SCALE_5_12C                                              ((FIT_YDS_GRADING_SCALE)22) // 5.12c
#define FIT_YDS_GRADING_SCALE_5_12D                                              ((FIT_YDS_GRADING_SCALE)23) // 5.12d
#define FIT_YDS_GRADING_SCALE_5_13                                               ((FIT_YDS_GRADING_SCALE)24) // 5.13
#define FIT_YDS_GRADING_SCALE_5_13A                                              ((FIT_YDS_GRADING_SCALE)25) // 5.13a
#define FIT_YDS_GRADING_SCALE_5_13B                                              ((FIT_YDS_GRADING_SCALE)26) // 5.13b
#define FIT_YDS_GRADING_SCALE_5_13C                                              ((FIT_YDS_GRADING_SCALE)27) // 5.13c
#define FIT_YDS_GRADING_SCALE_5_13D                                              ((FIT_YDS_GRADING_SCALE)28) // 5.13d
#define FIT_YDS_GRADING_SCALE_5_14                                               ((FIT_YDS_GRADING_SCALE)29) // 5.14
#define FIT_YDS_GRADING_SCALE_5_14A                                              ((FIT_YDS_GRADING_SCALE)30) // 5.14a
#define FIT_YDS_GRADING_SCALE_5_14B                                              ((FIT_YDS_GRADING_SCALE)31) // 5.14b
#define FIT_YDS_GRADING_SCALE_5_14C                                              ((FIT_YDS_GRADING_SCALE)32) // 5.14c
#define FIT_YDS_GRADING_SCALE_5_14D                                              ((FIT_YDS_GRADING_SCALE)33) // 5.14d
#define FIT_YDS_GRADING_SCALE_5_15                                               ((FIT_YDS_GRADING_SCALE)34) // 5.15
#define FIT_YDS_GRADING_SCALE_5_15A                                              ((FIT_YDS_GRADING_SCALE)35) // 5.15a
#define FIT_YDS_GRADING_SCALE_5_15B                                              ((FIT_YDS_GRADING_SCALE)36) // 5.15b
#define FIT_YDS_GRADING_SCALE_5_15C                                              ((FIT_YDS_GRADING_SCALE)37) // 5.15c
#define FIT_YDS_GRADING_SCALE_5_15D                                              ((FIT_YDS_GRADING_SCALE)38) // 5.15d
#define FIT_YDS_GRADING_SCALE_5_1_MINUS                                          ((FIT_YDS_GRADING_SCALE)39) // 5.1-
#define FIT_YDS_GRADING_SCALE_5_1_PLUS                                           ((FIT_YDS_GRADING_SCALE)40) // 5.1+
#define FIT_YDS_GRADING_SCALE_5_2_MINUS                                          ((FIT_YDS_GRADING_SCALE)41) // 5.2-
#define FIT_YDS_GRADING_SCALE_5_2_PLUS                                           ((FIT_YDS_GRADING_SCALE)42) // 5.2+
#define FIT_YDS_GRADING_SCALE_5_3_MINUS                                          ((FIT_YDS_GRADING_SCALE)43) // 5.3-
#define FIT_YDS_GRADING_SCALE_5_3_PLUS                                           ((FIT_YDS_GRADING_SCALE)44) // 5.3+
#define FIT_YDS_GRADING_SCALE_5_4_MINUS                                          ((FIT_YDS_GRADING_SCALE)45) // 5.4-
#define FIT_YDS_GRADING_SCALE_5_4_PLUS                                           ((FIT_YDS_GRADING_SCALE)46) // 5.4+
#define FIT_YDS_GRADING_SCALE_5_5_MINUS                                          ((FIT_YDS_GRADING_SCALE)47) // 5.5-
#define FIT_YDS_GRADING_SCALE_5_5_PLUS                                           ((FIT_YDS_GRADING_SCALE)48) // 5.5+
#define FIT_YDS_GRADING_SCALE_5_6_MINUS                                          ((FIT_YDS_GRADING_SCALE)49) // 5.6-
#define FIT_YDS_GRADING_SCALE_5_6_PLUS                                           ((FIT_YDS_GRADING_SCALE)50) // 5.6+
#define FIT_YDS_GRADING_SCALE_5_7_MINUS                                          ((FIT_YDS_GRADING_SCALE)51) // 5.7-
#define FIT_YDS_GRADING_SCALE_5_7_PLUS                                           ((FIT_YDS_GRADING_SCALE)52) // 5.7+
#define FIT_YDS_GRADING_SCALE_5_8_MINUS                                          ((FIT_YDS_GRADING_SCALE)53) // 5.8-
#define FIT_YDS_GRADING_SCALE_5_8_PLUS                                           ((FIT_YDS_GRADING_SCALE)54) // 5.8+
#define FIT_YDS_GRADING_SCALE_5_9_MINUS                                          ((FIT_YDS_GRADING_SCALE)55) // 5.9-
#define FIT_YDS_GRADING_SCALE_5_9_PLUS                                           ((FIT_YDS_GRADING_SCALE)56) // 5.9+
#define FIT_YDS_GRADING_SCALE_5_10_MINUS                                         ((FIT_YDS_GRADING_SCALE)57) // 5.10-
#define FIT_YDS_GRADING_SCALE_5_10_PLUS                                          ((FIT_YDS_GRADING_SCALE)58) // 5.10+
#define FIT_YDS_GRADING_SCALE_5_11_MINUS                                         ((FIT_YDS_GRADING_SCALE)59) // 5.11-
#define FIT_YDS_GRADING_SCALE_5_11_PLUS                                          ((FIT_YDS_GRADING_SCALE)60) // 5.11+
#define FIT_YDS_GRADING_SCALE_5_12_MINUS                                         ((FIT_YDS_GRADING_SCALE)61) // 5.12-
#define FIT_YDS_GRADING_SCALE_5_12_PLUS                                          ((FIT_YDS_GRADING_SCALE)62) // 5.12+
#define FIT_YDS_GRADING_SCALE_5_13_MINUS                                         ((FIT_YDS_GRADING_SCALE)63) // 5.13-
#define FIT_YDS_GRADING_SCALE_5_13_PLUS                                          ((FIT_YDS_GRADING_SCALE)64) // 5.13+
#define FIT_YDS_GRADING_SCALE_5_14_MINUS                                         ((FIT_YDS_GRADING_SCALE)65) // 5.14-
#define FIT_YDS_GRADING_SCALE_5_14_PLUS                                          ((FIT_YDS_GRADING_SCALE)66) // 5.14+
#define FIT_YDS_GRADING_SCALE_5_15_MINUS                                         ((FIT_YDS_GRADING_SCALE)67) // 5.15-
#define FIT_YDS_GRADING_SCALE_5_15_PLUS                                          ((FIT_YDS_GRADING_SCALE)68) // 5.15+
#define FIT_YDS_GRADING_SCALE_COUNT                                              69

typedef FIT_ENUM FIT_UIAA_GRADING_SCALE;
#define FIT_UIAA_GRADING_SCALE_INVALID                                           FIT_ENUM_INVALID
#define FIT_UIAA_GRADING_SCALE_I                                                 ((FIT_UIAA_GRADING_SCALE)0) // I
#define FIT_UIAA_GRADING_SCALE_II                                                ((FIT_UIAA_GRADING_SCALE)1) // II
#define FIT_UIAA_GRADING_SCALE_III                                               ((FIT_UIAA_GRADING_SCALE)2) // III
#define FIT_UIAA_GRADING_SCALE_IV_MINUS                                          ((FIT_UIAA_GRADING_SCALE)3) // IV-
#define FIT_UIAA_GRADING_SCALE_IV                                                ((FIT_UIAA_GRADING_SCALE)4) // IV
#define FIT_UIAA_GRADING_SCALE_IV_PLUS                                           ((FIT_UIAA_GRADING_SCALE)5) // IV+
#define FIT_UIAA_GRADING_SCALE_V_MINUS                                           ((FIT_UIAA_GRADING_SCALE)6) // V-
#define FIT_UIAA_GRADING_SCALE_V                                                 ((FIT_UIAA_GRADING_SCALE)7) // V
#define FIT_UIAA_GRADING_SCALE_V_PLUS                                            ((FIT_UIAA_GRADING_SCALE)8) // V+
#define FIT_UIAA_GRADING_SCALE_VI_MINUS                                          ((FIT_UIAA_GRADING_SCALE)9) // VI-
#define FIT_UIAA_GRADING_SCALE_VI                                                ((FIT_UIAA_GRADING_SCALE)10) // VI
#define FIT_UIAA_GRADING_SCALE_VI_PLUS                                           ((FIT_UIAA_GRADING_SCALE)11) // VI+
#define FIT_UIAA_GRADING_SCALE_VII_MINUS                                         ((FIT_UIAA_GRADING_SCALE)12) // VII-
#define FIT_UIAA_GRADING_SCALE_VII                                               ((FIT_UIAA_GRADING_SCALE)13) // VII
#define FIT_UIAA_GRADING_SCALE_VII_PLUS                                          ((FIT_UIAA_GRADING_SCALE)14) // VII+
#define FIT_UIAA_GRADING_SCALE_VIII_MINUS                                        ((FIT_UIAA_GRADING_SCALE)15) // VIII-
#define FIT_UIAA_GRADING_SCALE_VIII                                              ((FIT_UIAA_GRADING_SCALE)16) // VIII
#define FIT_UIAA_GRADING_SCALE_VIII_PLUS                                         ((FIT_UIAA_GRADING_SCALE)17) // VIII+
#define FIT_UIAA_GRADING_SCALE_IX_MINUS                                          ((FIT_UIAA_GRADING_SCALE)18) // IX-
#define FIT_UIAA_GRADING_SCALE_IX                                                ((FIT_UIAA_GRADING_SCALE)19) // IX
#define FIT_UIAA_GRADING_SCALE_IX_PLUS                                           ((FIT_UIAA_GRADING_SCALE)20) // IX+
#define FIT_UIAA_GRADING_SCALE_X_MINUS                                           ((FIT_UIAA_GRADING_SCALE)21) // X-
#define FIT_UIAA_GRADING_SCALE_X                                                 ((FIT_UIAA_GRADING_SCALE)22) // X
#define FIT_UIAA_GRADING_SCALE_X_PLUS                                            ((FIT_UIAA_GRADING_SCALE)23) // X+
#define FIT_UIAA_GRADING_SCALE_XI_MINUS                                          ((FIT_UIAA_GRADING_SCALE)24) // XI-
#define FIT_UIAA_GRADING_SCALE_XI                                                ((FIT_UIAA_GRADING_SCALE)25) // XI
#define FIT_UIAA_GRADING_SCALE_XI_PLUS                                           ((FIT_UIAA_GRADING_SCALE)26) // XI+
#define FIT_UIAA_GRADING_SCALE_XII_MINUS                                         ((FIT_UIAA_GRADING_SCALE)27) // XII-
#define FIT_UIAA_GRADING_SCALE_COUNT                                             28

typedef FIT_ENUM FIT_FRENCH_GRADING_SCALE;
#define FIT_FRENCH_GRADING_SCALE_INVALID                                         FIT_ENUM_INVALID
#define FIT_FRENCH_GRADING_SCALE_1                                               ((FIT_FRENCH_GRADING_SCALE)0) // 1
#define FIT_FRENCH_GRADING_SCALE_2                                               ((FIT_FRENCH_GRADING_SCALE)1) // 2
#define FIT_FRENCH_GRADING_SCALE_3                                               ((FIT_FRENCH_GRADING_SCALE)2) // 3
#define FIT_FRENCH_GRADING_SCALE_4A                                              ((FIT_FRENCH_GRADING_SCALE)3) // 4a
#define FIT_FRENCH_GRADING_SCALE_4B                                              ((FIT_FRENCH_GRADING_SCALE)4) // 4b
#define FIT_FRENCH_GRADING_SCALE_4C                                              ((FIT_FRENCH_GRADING_SCALE)5) // 4c
#define FIT_FRENCH_GRADING_SCALE_5A                                              ((FIT_FRENCH_GRADING_SCALE)6) // 5a
#define FIT_FRENCH_GRADING_SCALE_5B                                              ((FIT_FRENCH_GRADING_SCALE)7) // 5b
#define FIT_FRENCH_GRADING_SCALE_5C                                              ((FIT_FRENCH_GRADING_SCALE)8) // 5c
#define FIT_FRENCH_GRADING_SCALE_6A                                              ((FIT_FRENCH_GRADING_SCALE)9) // 6a
#define FIT_FRENCH_GRADING_SCALE_6A_PLUS                                         ((FIT_FRENCH_GRADING_SCALE)10) // 6a+
#define FIT_FRENCH_GRADING_SCALE_6B                                              ((FIT_FRENCH_GRADING_SCALE)11) // 6b
#define FIT_FRENCH_GRADING_SCALE_6B_PLUS                                         ((FIT_FRENCH_GRADING_SCALE)12) // 6b+
#define FIT_FRENCH_GRADING_SCALE_6C                                              ((FIT_FRENCH_GRADING_SCALE)13) // 6c
#define FIT_FRENCH_GRADING_SCALE_6C_PLUS                                         ((FIT_FRENCH_GRADING_SCALE)14) // 6c+
#define FIT_FRENCH_GRADING_SCALE_7A                                              ((FIT_FRENCH_GRADING_SCALE)15) // 7a
#define FIT_FRENCH_GRADING_SCALE_7A_PLUS                                         ((FIT_FRENCH_GRADING_SCALE)16) // 7a+
#define FIT_FRENCH_GRADING_SCALE_7B                                              ((FIT_FRENCH_GRADING_SCALE)17) // 7b
#define FIT_FRENCH_GRADING_SCALE_7B_PLUS                                         ((FIT_FRENCH_GRADING_SCALE)18) // 7b+
#define FIT_FRENCH_GRADING_SCALE_7C                                              ((FIT_FRENCH_GRADING_SCALE)19) // 7c
#define FIT_FRENCH_GRADING_SCALE_7C_PLUS                                         ((FIT_FRENCH_GRADING_SCALE)20) // 7c+
#define FIT_FRENCH_GRADING_SCALE_8A                                              ((FIT_FRENCH_GRADING_SCALE)21) // 8a
#define FIT_FRENCH_GRADING_SCALE_8A_PLUS                                         ((FIT_FRENCH_GRADING_SCALE)22) // 8a+
#define FIT_FRENCH_GRADING_SCALE_8B                                              ((FIT_FRENCH_GRADING_SCALE)23) // 8b
#define FIT_FRENCH_GRADING_SCALE_8B_PLUS                                         ((FIT_FRENCH_GRADING_SCALE)24) // 8b+
#define FIT_FRENCH_GRADING_SCALE_8C                                              ((FIT_FRENCH_GRADING_SCALE)25) // 8c
#define FIT_FRENCH_GRADING_SCALE_8C_PLUS                                         ((FIT_FRENCH_GRADING_SCALE)26) // 8c+
#define FIT_FRENCH_GRADING_SCALE_9A                                              ((FIT_FRENCH_GRADING_SCALE)27) // 9a
#define FIT_FRENCH_GRADING_SCALE_9A_PLUS                                         ((FIT_FRENCH_GRADING_SCALE)28) // 9a+
#define FIT_FRENCH_GRADING_SCALE_9B                                              ((FIT_FRENCH_GRADING_SCALE)29) // 9b
#define FIT_FRENCH_GRADING_SCALE_COUNT                                           30

typedef FIT_ENUM FIT_BRITISH_ADJECTIVAL_GRADING_SCALE;
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_INVALID                             FIT_ENUM_INVALID
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_M                                   ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)0) // M
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_D                                   ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)1) // D
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_HD                                  ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)2) // HD
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_VD                                  ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)3) // VD
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_MS                                  ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)4) // MS
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_S                                   ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)5) // S
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_HS                                  ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)6) // HS
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_MVS                                 ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)7) // MVS
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_VS                                  ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)8) // VS
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_HVS                                 ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)9) // HVS
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_E1                                  ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)10) // E1
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_E2                                  ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)11) // E2
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_E3                                  ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)12) // E3
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_E4                                  ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)13) // E4
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_E5                                  ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)14) // E5
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_E6                                  ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)15) // E6
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_E7                                  ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)16) // E7
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_E8                                  ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)17) // E8
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_E9                                  ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)18) // E9
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_E10                                 ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)19) // E10
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_E11                                 ((FIT_BRITISH_ADJECTIVAL_GRADING_SCALE)20) // E11
#define FIT_BRITISH_ADJECTIVAL_GRADING_SCALE_COUNT                               21

typedef FIT_ENUM FIT_BRITISH_TECHNICAL_GRADING_SCALE;
#define FIT_BRITISH_TECHNICAL_GRADING_SCALE_INVALID                              FIT_ENUM_INVALID
#define FIT_BRITISH_TECHNICAL_GRADING_SCALE_1                                    ((FIT_BRITISH_TECHNICAL_GRADING_SCALE)0) // 1
#define FIT_BRITISH_TECHNICAL_GRADING_SCALE_2                                    ((FIT_BRITISH_TECHNICAL_GRADING_SCALE)1) // 2
#define FIT_BRITISH_TECHNICAL_GRADING_SCALE_3                                    ((FIT_BRITISH_TECHNICAL_GRADING_SCALE)2) // 3
#define FIT_BRITISH_TECHNICAL_GRADING_SCALE_4A                                   ((FIT_BRITISH_TECHNICAL_GRADING_SCALE)3) // 4a
#define FIT_BRITISH_TECHNICAL_GRADING_SCALE_4B                                   ((FIT_BRITISH_TECHNICAL_GRADING_SCALE)4) // 4b
#define FIT_BRITISH_TECHNICAL_GRADING_SCALE_4C                                   ((FIT_BRITISH_TECHNICAL_GRADING_SCALE)5) // 4c
#define FIT_BRITISH_TECHNICAL_GRADING_SCALE_5A                                   ((FIT_BRITISH_TECHNICAL_GRADING_SCALE)6) // 5a
#define FIT_BRITISH_TECHNICAL_GRADING_SCALE_5B                                   ((FIT_BRITISH_TECHNICAL_GRADING_SCALE)7) // 5b
#define FIT_BRITISH_TECHNICAL_GRADING_SCALE_5C                                   ((FIT_BRITISH_TECHNICAL_GRADING_SCALE)8) // 5c
#define FIT_BRITISH_TECHNICAL_GRADING_SCALE_6A                                   ((FIT_BRITISH_TECHNICAL_GRADING_SCALE)9) // 6a
#define FIT_BRITISH_TECHNICAL_GRADING_SCALE_6B                                   ((FIT_BRITISH_TECHNICAL_GRADING_SCALE)10) // 6b
#define FIT_BRITISH_TECHNICAL_GRADING_SCALE_6C                                   ((FIT_BRITISH_TECHNICAL_GRADING_SCALE)11) // 6c
#define FIT_BRITISH_TECHNICAL_GRADING_SCALE_7A                                   ((FIT_BRITISH_TECHNICAL_GRADING_SCALE)12) // 7a
#define FIT_BRITISH_TECHNICAL_GRADING_SCALE_7B                                   ((FIT_BRITISH_TECHNICAL_GRADING_SCALE)13) // 7b
#define FIT_BRITISH_TECHNICAL_GRADING_SCALE_7C                                   ((FIT_BRITISH_TECHNICAL_GRADING_SCALE)14) // 7c
#define FIT_BRITISH_TECHNICAL_GRADING_SCALE_COUNT                                15

typedef FIT_ENUM FIT_EWBANK_GRADING_SCALE;
#define FIT_EWBANK_GRADING_SCALE_INVALID                                         FIT_ENUM_INVALID
#define FIT_EWBANK_GRADING_SCALE_4                                               ((FIT_EWBANK_GRADING_SCALE)0) // 4
#define FIT_EWBANK_GRADING_SCALE_5                                               ((FIT_EWBANK_GRADING_SCALE)1) // 5
#define FIT_EWBANK_GRADING_SCALE_6                                               ((FIT_EWBANK_GRADING_SCALE)2) // 6
#define FIT_EWBANK_GRADING_SCALE_7                                               ((FIT_EWBANK_GRADING_SCALE)3) // 7
#define FIT_EWBANK_GRADING_SCALE_8                                               ((FIT_EWBANK_GRADING_SCALE)4) // 8
#define FIT_EWBANK_GRADING_SCALE_9                                               ((FIT_EWBANK_GRADING_SCALE)5) // 9
#define FIT_EWBANK_GRADING_SCALE_10                                              ((FIT_EWBANK_GRADING_SCALE)6) // 10
#define FIT_EWBANK_GRADING_SCALE_11                                              ((FIT_EWBANK_GRADING_SCALE)7) // 11
#define FIT_EWBANK_GRADING_SCALE_12                                              ((FIT_EWBANK_GRADING_SCALE)8) // 12
#define FIT_EWBANK_GRADING_SCALE_13                                              ((FIT_EWBANK_GRADING_SCALE)9) // 13
#define FIT_EWBANK_GRADING_SCALE_14                                              ((FIT_EWBANK_GRADING_SCALE)10) // 14
#define FIT_EWBANK_GRADING_SCALE_15                                              ((FIT_EWBANK_GRADING_SCALE)11) // 15
#define FIT_EWBANK_GRADING_SCALE_16                                              ((FIT_EWBANK_GRADING_SCALE)12) // 16
#define FIT_EWBANK_GRADING_SCALE_17                                              ((FIT_EWBANK_GRADING_SCALE)13) // 17
#define FIT_EWBANK_GRADING_SCALE_18                                              ((FIT_EWBANK_GRADING_SCALE)14) // 18
#define FIT_EWBANK_GRADING_SCALE_19                                              ((FIT_EWBANK_GRADING_SCALE)15) // 19
#define FIT_EWBANK_GRADING_SCALE_20                                              ((FIT_EWBANK_GRADING_SCALE)16) // 20
#define FIT_EWBANK_GRADING_SCALE_21                                              ((FIT_EWBANK_GRADING_SCALE)17) // 21
#define FIT_EWBANK_GRADING_SCALE_22                                              ((FIT_EWBANK_GRADING_SCALE)18) // 22
#define FIT_EWBANK_GRADING_SCALE_23                                              ((FIT_EWBANK_GRADING_SCALE)19) // 23
#define FIT_EWBANK_GRADING_SCALE_24                                              ((FIT_EWBANK_GRADING_SCALE)20) // 24
#define FIT_EWBANK_GRADING_SCALE_25                                              ((FIT_EWBANK_GRADING_SCALE)21) // 25
#define FIT_EWBANK_GRADING_SCALE_26                                              ((FIT_EWBANK_GRADING_SCALE)22) // 26
#define FIT_EWBANK_GRADING_SCALE_27                                              ((FIT_EWBANK_GRADING_SCALE)23) // 27
#define FIT_EWBANK_GRADING_SCALE_28                                              ((FIT_EWBANK_GRADING_SCALE)24) // 28
#define FIT_EWBANK_GRADING_SCALE_29                                              ((FIT_EWBANK_GRADING_SCALE)25) // 29
#define FIT_EWBANK_GRADING_SCALE_30                                              ((FIT_EWBANK_GRADING_SCALE)26) // 30
#define FIT_EWBANK_GRADING_SCALE_31                                              ((FIT_EWBANK_GRADING_SCALE)27) // 31
#define FIT_EWBANK_GRADING_SCALE_32                                              ((FIT_EWBANK_GRADING_SCALE)28) // 32
#define FIT_EWBANK_GRADING_SCALE_33                                              ((FIT_EWBANK_GRADING_SCALE)29) // 33
#define FIT_EWBANK_GRADING_SCALE_34                                              ((FIT_EWBANK_GRADING_SCALE)30) // 34
#define FIT_EWBANK_GRADING_SCALE_35                                              ((FIT_EWBANK_GRADING_SCALE)31) // 35
#define FIT_EWBANK_GRADING_SCALE_36                                              ((FIT_EWBANK_GRADING_SCALE)32) // 36
#define FIT_EWBANK_GRADING_SCALE_37                                              ((FIT_EWBANK_GRADING_SCALE)33) // 37
#define FIT_EWBANK_GRADING_SCALE_38                                              ((FIT_EWBANK_GRADING_SCALE)34) // 38
#define FIT_EWBANK_GRADING_SCALE_COUNT                                           35

typedef FIT_ENUM FIT_BRAZILIAN_GRADING_SCALE;
#define FIT_BRAZILIAN_GRADING_SCALE_INVALID                                      FIT_ENUM_INVALID
#define FIT_BRAZILIAN_GRADING_SCALE_2                                            ((FIT_BRAZILIAN_GRADING_SCALE)0) // 2
#define FIT_BRAZILIAN_GRADING_SCALE_3                                            ((FIT_BRAZILIAN_GRADING_SCALE)1) // 3
#define FIT_BRAZILIAN_GRADING_SCALE_3C                                           ((FIT_BRAZILIAN_GRADING_SCALE)2) // 3c
#define FIT_BRAZILIAN_GRADING_SCALE_4                                            ((FIT_BRAZILIAN_GRADING_SCALE)3) // 4
#define FIT_BRAZILIAN_GRADING_SCALE_5A                                           ((FIT_BRAZILIAN_GRADING_SCALE)4) // 5a
#define FIT_BRAZILIAN_GRADING_SCALE_5B                                           ((FIT_BRAZILIAN_GRADING_SCALE)5) // 5b
#define FIT_BRAZILIAN_GRADING_SCALE_5C                                           ((FIT_BRAZILIAN_GRADING_SCALE)6) // 5c
#define FIT_BRAZILIAN_GRADING_SCALE_6A                                           ((FIT_BRAZILIAN_GRADING_SCALE)7) // 6a
#define FIT_BRAZILIAN_GRADING_SCALE_6B                                           ((FIT_BRAZILIAN_GRADING_SCALE)8) // 6b
#define FIT_BRAZILIAN_GRADING_SCALE_6C                                           ((FIT_BRAZILIAN_GRADING_SCALE)9) // 6c
#define FIT_BRAZILIAN_GRADING_SCALE_7A                                           ((FIT_BRAZILIAN_GRADING_SCALE)10) // 7a
#define FIT_BRAZILIAN_GRADING_SCALE_7B                                           ((FIT_BRAZILIAN_GRADING_SCALE)11) // 7b
#define FIT_BRAZILIAN_GRADING_SCALE_7C                                           ((FIT_BRAZILIAN_GRADING_SCALE)12) // 7c
#define FIT_BRAZILIAN_GRADING_SCALE_8A                                           ((FIT_BRAZILIAN_GRADING_SCALE)13) // 8a
#define FIT_BRAZILIAN_GRADING_SCALE_8B                                           ((FIT_BRAZILIAN_GRADING_SCALE)14) // 8b
#define FIT_BRAZILIAN_GRADING_SCALE_8C                                           ((FIT_BRAZILIAN_GRADING_SCALE)15) // 8c
#define FIT_BRAZILIAN_GRADING_SCALE_9A                                           ((FIT_BRAZILIAN_GRADING_SCALE)16) // 9a
#define FIT_BRAZILIAN_GRADING_SCALE_9B                                           ((FIT_BRAZILIAN_GRADING_SCALE)17) // 9b
#define FIT_BRAZILIAN_GRADING_SCALE_9C                                           ((FIT_BRAZILIAN_GRADING_SCALE)18) // 9c
#define FIT_BRAZILIAN_GRADING_SCALE_10A                                          ((FIT_BRAZILIAN_GRADING_SCALE)19) // 10a
#define FIT_BRAZILIAN_GRADING_SCALE_10B                                          ((FIT_BRAZILIAN_GRADING_SCALE)20) // 10b
#define FIT_BRAZILIAN_GRADING_SCALE_10C                                          ((FIT_BRAZILIAN_GRADING_SCALE)21) // 10c
#define FIT_BRAZILIAN_GRADING_SCALE_11A                                          ((FIT_BRAZILIAN_GRADING_SCALE)22) // 11a
#define FIT_BRAZILIAN_GRADING_SCALE_11B                                          ((FIT_BRAZILIAN_GRADING_SCALE)23) // 11b
#define FIT_BRAZILIAN_GRADING_SCALE_11C                                          ((FIT_BRAZILIAN_GRADING_SCALE)24) // 11c
#define FIT_BRAZILIAN_GRADING_SCALE_12A                                          ((FIT_BRAZILIAN_GRADING_SCALE)25) // 12a
#define FIT_BRAZILIAN_GRADING_SCALE_12B                                          ((FIT_BRAZILIAN_GRADING_SCALE)26) // 12b
#define FIT_BRAZILIAN_GRADING_SCALE_COUNT                                        27

typedef FIT_ENUM FIT_SAXON_GRADING_SCALE;
#define FIT_SAXON_GRADING_SCALE_INVALID                                          FIT_ENUM_INVALID
#define FIT_SAXON_GRADING_SCALE_I                                                ((FIT_SAXON_GRADING_SCALE)0) // I
#define FIT_SAXON_GRADING_SCALE_II                                               ((FIT_SAXON_GRADING_SCALE)1) // II
#define FIT_SAXON_GRADING_SCALE_III                                              ((FIT_SAXON_GRADING_SCALE)2) // III
#define FIT_SAXON_GRADING_SCALE_IV                                               ((FIT_SAXON_GRADING_SCALE)3) // IV
#define FIT_SAXON_GRADING_SCALE_V                                                ((FIT_SAXON_GRADING_SCALE)4) // V
#define FIT_SAXON_GRADING_SCALE_VI                                               ((FIT_SAXON_GRADING_SCALE)5) // VI
#define FIT_SAXON_GRADING_SCALE_VII_A                                            ((FIT_SAXON_GRADING_SCALE)6) // VIIa
#define FIT_SAXON_GRADING_SCALE_VII_B                                            ((FIT_SAXON_GRADING_SCALE)7) // VIIb
#define FIT_SAXON_GRADING_SCALE_VII_C                                            ((FIT_SAXON_GRADING_SCALE)8) // VIIc
#define FIT_SAXON_GRADING_SCALE_VIII_A                                           ((FIT_SAXON_GRADING_SCALE)9) // VIIIa
#define FIT_SAXON_GRADING_SCALE_VIII_B                                           ((FIT_SAXON_GRADING_SCALE)10) // VIIIb
#define FIT_SAXON_GRADING_SCALE_VIII_C                                           ((FIT_SAXON_GRADING_SCALE)11) // VIIIc
#define FIT_SAXON_GRADING_SCALE_IX_A                                             ((FIT_SAXON_GRADING_SCALE)12) // IXa
#define FIT_SAXON_GRADING_SCALE_IX_B                                             ((FIT_SAXON_GRADING_SCALE)13) // IXb
#define FIT_SAXON_GRADING_SCALE_IX_C                                             ((FIT_SAXON_GRADING_SCALE)14) // IXc
#define FIT_SAXON_GRADING_SCALE_X_A                                              ((FIT_SAXON_GRADING_SCALE)15) // Xa
#define FIT_SAXON_GRADING_SCALE_X_B                                              ((FIT_SAXON_GRADING_SCALE)16) // Xb
#define FIT_SAXON_GRADING_SCALE_X_C                                              ((FIT_SAXON_GRADING_SCALE)17) // Xc
#define FIT_SAXON_GRADING_SCALE_XI_A                                             ((FIT_SAXON_GRADING_SCALE)18) // XIa
#define FIT_SAXON_GRADING_SCALE_XI_B                                             ((FIT_SAXON_GRADING_SCALE)19) // XIb
#define FIT_SAXON_GRADING_SCALE_XI_C                                             ((FIT_SAXON_GRADING_SCALE)20) // XIc
#define FIT_SAXON_GRADING_SCALE_XII_A                                            ((FIT_SAXON_GRADING_SCALE)21) // XIIa
#define FIT_SAXON_GRADING_SCALE_XII_B                                            ((FIT_SAXON_GRADING_SCALE)22) // XIIb
#define FIT_SAXON_GRADING_SCALE_XII_C                                            ((FIT_SAXON_GRADING_SCALE)23) // XIIc
#define FIT_SAXON_GRADING_SCALE_COUNT                                            24

typedef FIT_ENUM FIT_VERMIN_GRADING_SCALE;
#define FIT_VERMIN_GRADING_SCALE_INVALID                                         FIT_ENUM_INVALID
#define FIT_VERMIN_GRADING_SCALE_VB                                              ((FIT_VERMIN_GRADING_SCALE)0) // VB
#define FIT_VERMIN_GRADING_SCALE_V0                                              ((FIT_VERMIN_GRADING_SCALE)1) // V0
#define FIT_VERMIN_GRADING_SCALE_V1                                              ((FIT_VERMIN_GRADING_SCALE)2) // V1
#define FIT_VERMIN_GRADING_SCALE_V2                                              ((FIT_VERMIN_GRADING_SCALE)3) // V2
#define FIT_VERMIN_GRADING_SCALE_V3                                              ((FIT_VERMIN_GRADING_SCALE)4) // V3
#define FIT_VERMIN_GRADING_SCALE_V4                                              ((FIT_VERMIN_GRADING_SCALE)5) // V4
#define FIT_VERMIN_GRADING_SCALE_V5                                              ((FIT_VERMIN_GRADING_SCALE)6) // V5
#define FIT_VERMIN_GRADING_SCALE_V6                                              ((FIT_VERMIN_GRADING_SCALE)7) // V6
#define FIT_VERMIN_GRADING_SCALE_V7                                              ((FIT_VERMIN_GRADING_SCALE)8) // V7
#define FIT_VERMIN_GRADING_SCALE_V8                                              ((FIT_VERMIN_GRADING_SCALE)9) // V8
#define FIT_VERMIN_GRADING_SCALE_V9                                              ((FIT_VERMIN_GRADING_SCALE)10) // V9
#define FIT_VERMIN_GRADING_SCALE_V10                                             ((FIT_VERMIN_GRADING_SCALE)11) // V10
#define FIT_VERMIN_GRADING_SCALE_V11                                             ((FIT_VERMIN_GRADING_SCALE)12) // V11
#define FIT_VERMIN_GRADING_SCALE_V12                                             ((FIT_VERMIN_GRADING_SCALE)13) // V12
#define FIT_VERMIN_GRADING_SCALE_V13                                             ((FIT_VERMIN_GRADING_SCALE)14) // V13
#define FIT_VERMIN_GRADING_SCALE_V14                                             ((FIT_VERMIN_GRADING_SCALE)15) // V14
#define FIT_VERMIN_GRADING_SCALE_V15                                             ((FIT_VERMIN_GRADING_SCALE)16) // V15
#define FIT_VERMIN_GRADING_SCALE_V16                                             ((FIT_VERMIN_GRADING_SCALE)17) // V16
#define FIT_VERMIN_GRADING_SCALE_V17                                             ((FIT_VERMIN_GRADING_SCALE)18) // V17
#define FIT_VERMIN_GRADING_SCALE_COUNT                                           19

typedef FIT_ENUM FIT_FONT_GRADING_SCALE;
#define FIT_FONT_GRADING_SCALE_INVALID                                           FIT_ENUM_INVALID
#define FIT_FONT_GRADING_SCALE_1                                                 ((FIT_FONT_GRADING_SCALE)0) // 1
#define FIT_FONT_GRADING_SCALE_2                                                 ((FIT_FONT_GRADING_SCALE)1) // 2
#define FIT_FONT_GRADING_SCALE_3                                                 ((FIT_FONT_GRADING_SCALE)2) // 3
#define FIT_FONT_GRADING_SCALE_4                                                 ((FIT_FONT_GRADING_SCALE)3) // 4
#define FIT_FONT_GRADING_SCALE_4_PLUS                                            ((FIT_FONT_GRADING_SCALE)4) // 4+
#define FIT_FONT_GRADING_SCALE_5                                                 ((FIT_FONT_GRADING_SCALE)5) // 5
#define FIT_FONT_GRADING_SCALE_5_PLUS                                            ((FIT_FONT_GRADING_SCALE)6) // 5+
#define FIT_FONT_GRADING_SCALE_6A                                                ((FIT_FONT_GRADING_SCALE)7) // 6A
#define FIT_FONT_GRADING_SCALE_6A_PLUS                                           ((FIT_FONT_GRADING_SCALE)8) // 6A+
#define FIT_FONT_GRADING_SCALE_6B                                                ((FIT_FONT_GRADING_SCALE)9) // 6B
#define FIT_FONT_GRADING_SCALE_6B_PLUS                                           ((FIT_FONT_GRADING_SCALE)10) // 6B+
#define FIT_FONT_GRADING_SCALE_6C                                                ((FIT_FONT_GRADING_SCALE)11) // 6C
#define FIT_FONT_GRADING_SCALE_6C_PLUS                                           ((FIT_FONT_GRADING_SCALE)12) // 6C+
#define FIT_FONT_GRADING_SCALE_7A                                                ((FIT_FONT_GRADING_SCALE)13) // 7A
#define FIT_FONT_GRADING_SCALE_7A_PLUS                                           ((FIT_FONT_GRADING_SCALE)14) // 7A+
#define FIT_FONT_GRADING_SCALE_7B                                                ((FIT_FONT_GRADING_SCALE)15) // 7B
#define FIT_FONT_GRADING_SCALE_7B_PLUS                                           ((FIT_FONT_GRADING_SCALE)16) // 7B+
#define FIT_FONT_GRADING_SCALE_7C                                                ((FIT_FONT_GRADING_SCALE)17) // 7C
#define FIT_FONT_GRADING_SCALE_7C_PLUS                                           ((FIT_FONT_GRADING_SCALE)18) // 7C+
#define FIT_FONT_GRADING_SCALE_8A                                                ((FIT_FONT_GRADING_SCALE)19) // 8A
#define FIT_FONT_GRADING_SCALE_8A_PLUS                                           ((FIT_FONT_GRADING_SCALE)20) // 8A+
#define FIT_FONT_GRADING_SCALE_8B                                                ((FIT_FONT_GRADING_SCALE)21) // 8B
#define FIT_FONT_GRADING_SCALE_8B_PLUS                                           ((FIT_FONT_GRADING_SCALE)22) // 8B+
#define FIT_FONT_GRADING_SCALE_8C                                                ((FIT_FONT_GRADING_SCALE)23) // 8C
#define FIT_FONT_GRADING_SCALE_8C_PLUS                                           ((FIT_FONT_GRADING_SCALE)24) // 8C+
#define FIT_FONT_GRADING_SCALE_9A                                                ((FIT_FONT_GRADING_SCALE)25) // 9A
#define FIT_FONT_GRADING_SCALE_COUNT                                             26

typedef FIT_ENUM FIT_DANKYU_GRADING_SCALE;
#define FIT_DANKYU_GRADING_SCALE_INVALID                                         FIT_ENUM_INVALID
#define FIT_DANKYU_GRADING_SCALE_7_KYUU                                          ((FIT_DANKYU_GRADING_SCALE)0) // 7 kyuu
#define FIT_DANKYU_GRADING_SCALE_6_KYUU                                          ((FIT_DANKYU_GRADING_SCALE)1) // 6 kyuu
#define FIT_DANKYU_GRADING_SCALE_5_KYUU                                          ((FIT_DANKYU_GRADING_SCALE)2) // 5 kyuu
#define FIT_DANKYU_GRADING_SCALE_4_KYUU                                          ((FIT_DANKYU_GRADING_SCALE)3) // 4 kyuu
#define FIT_DANKYU_GRADING_SCALE_3_KYUU                                          ((FIT_DANKYU_GRADING_SCALE)4) // 3 kyuu
#define FIT_DANKYU_GRADING_SCALE_2_KYUU                                          ((FIT_DANKYU_GRADING_SCALE)5) // 2 kyuu
#define FIT_DANKYU_GRADING_SCALE_1_KYUU                                          ((FIT_DANKYU_GRADING_SCALE)6) // 1 kyuu
#define FIT_DANKYU_GRADING_SCALE_1_DAN                                           ((FIT_DANKYU_GRADING_SCALE)7) // 1 dan
#define FIT_DANKYU_GRADING_SCALE_2_DAN                                           ((FIT_DANKYU_GRADING_SCALE)8) // 2 dan
#define FIT_DANKYU_GRADING_SCALE_3_DAN                                           ((FIT_DANKYU_GRADING_SCALE)9) // 3 dan
#define FIT_DANKYU_GRADING_SCALE_4_DAN                                           ((FIT_DANKYU_GRADING_SCALE)10) // 4 dan
#define FIT_DANKYU_GRADING_SCALE_5_DAN                                           ((FIT_DANKYU_GRADING_SCALE)11) // 5 dan
#define FIT_DANKYU_GRADING_SCALE_COUNT                                           12

typedef FIT_ENUM FIT_SPLIT_STATUS; // Use with indoor climbing activities only
#define FIT_SPLIT_STATUS_INVALID                                                 FIT_ENUM_INVALID
#define FIT_SPLIT_STATUS_FAILURE                                                 ((FIT_SPLIT_STATUS)0)
#define FIT_SPLIT_STATUS_SUCCESS                                                 ((FIT_SPLIT_STATUS)1)
#define FIT_SPLIT_STATUS_CLIMB_ATTEMPTED                                         ((FIT_SPLIT_STATUS)2)
#define FIT_SPLIT_STATUS_CLIMB_COMPLETED                                         ((FIT_SPLIT_STATUS)3)
#define FIT_SPLIT_STATUS_COUNT                                                   4
...
#define FIT_NAP_PERIOD_FEEDBACK_NONE                                             ((FIT_NAP_PERIOD_FEEDBACK)0)
#define FIT_NAP_PERIOD_FEEDBACK_MULTIPLE_NAPS_DURING_DAY                         ((FIT_NAP_PERIOD_FEEDBACK)1)
#define FIT_NAP_PERIOD_FEEDBACK_JETLAG_IDEAL_TIMING_IDEAL_DURATION               ((FIT_NAP_PERIOD_FEEDBACK)2)
#define FIT_NAP_PERIOD_FEEDBACK_JETLAG_IDEAL_TIMING_LONG_DURATION                ((FIT_NAP_PERIOD_FEEDBACK)3)
#define FIT_NAP_PERIOD_FEEDBACK_JETLAG_LATE_TIMING_IDEAL_DURATION                ((FIT_NAP_PERIOD_FEEDBACK)4)
#define FIT_NAP_PERIOD_FEEDBACK_JETLAG_LATE_TIMING_LONG_DURATION                 ((FIT_NAP_PERIOD_FEEDBACK)5)
#define FIT_NAP_PERIOD_FEEDBACK_IDEAL_TIMING_IDEAL_DURATION_LOW_NEED             ((FIT_NAP_PERIOD_FEEDBACK)6)
#define FIT_NAP_PERIOD_FEEDBACK_IDEAL_TIMING_IDEAL_DURATION_HIGH_NEED            ((FIT_NAP_PERIOD_FEEDBACK)7)
#define FIT_NAP_PERIOD_FEEDBACK_IDEAL_TIMING_LONG_DURATION_LOW_NEED              ((FIT_NAP_PERIOD_FEEDBACK)8)
#define FIT_NAP_PERIOD_FEEDBACK_IDEAL_TIMING_LONG_DURATION_HIGH_NEED             ((FIT_NAP_PERIOD_FEEDBACK)9)
#define FIT_NAP_PERIOD_FEEDBACK_LATE_TIMING_IDEAL_DURATION_LOW_NEED              ((FIT_NAP_PERIOD_FEEDBACK)10)
#define FIT_NAP_PERIOD_FEEDBACK_LATE_TIMING_IDEAL_DURATION_HIGH_NEED             ((FIT_NAP_PERIOD_FEEDBACK)11)
#define FIT_NAP_PERIOD_FEEDBACK_LATE_TIMING_LONG_DURATION_LOW_NEED               ((FIT_NAP_PERIOD_FEEDBACK)12)
#define FIT_NAP_PERIOD_FEEDBACK_LATE_TIMING_LONG_DURATION_HIGH_NEED              ((FIT_NAP_PERIOD_FEEDBACK)13)
#define FIT_NAP_PERIOD_FEEDBACK_IDEAL_DURATION_LOW_NEED                          ((FIT_NAP_PERIOD_FEEDBACK)14)
#define FIT_NAP_PERIOD_FEEDBACK_IDEAL_DURATION_HIGH_NEED                         ((FIT_NAP_PERIOD_FEEDBACK)15)
#define FIT_NAP_PERIOD_FEEDBACK_LONG_DURATION_LOW_NEED                           ((FIT_NAP_PERIOD_FEEDBACK)16)
#define FIT_NAP_PERIOD_FEEDBACK_LONG_DURATION_HIGH_NEED                          ((FIT_NAP_PERIOD_FEEDBACK)17)
#define FIT_NAP_PERIOD_FEEDBACK_COUNT                                            18

typedef FIT_ENUM FIT_NAP_SOURCE;
#define FIT_NAP_SOURCE_INVALID                                                   FIT_ENUM_INVALID
#define FIT_NAP_SOURCE_AUTOMATIC                                                 ((FIT_NAP_SOURCE)0)
#define FIT_NAP_SOURCE_MANUAL_DEVICE                                             ((FIT_NAP_SOURCE)1)
#define FIT_NAP_SOURCE_MANUAL_GC                                                 ((FIT_NAP_SOURCE)2)
...
typedef FIT_ENUM FIT_DIVE_SECTION_TYPE;
#define FIT_DIVE_SECTION_TYPE_INVALID                                            FIT_ENUM_INVALID
#define FIT_DIVE_SECTION_TYPE_ASCENT                                             ((FIT_DIVE_SECTION_TYPE)0)
#define FIT_DIVE_SECTION_TYPE_DESCENT                                            ((FIT_DIVE_SECTION_TYPE)1)
#define FIT_DIVE_SECTION_TYPE_HANG                                               ((FIT_DIVE_SECTION_TYPE)2)
#define FIT_DIVE_SECTION_TYPE_COUNT                                              3

typedef FIT_ENUM FIT_APNEA_DISCIPLINE;
#define FIT_APNEA_DISCIPLINE_INVALID                                             FIT_ENUM_INVALID
#define FIT_APNEA_DISCIPLINE_CONSTANT_WEIGHT_WITH_FINS                           ((FIT_APNEA_DISCIPLINE)0)
#define FIT_APNEA_DISCIPLINE_CONSTANT_WEIGHT_WITH_BIFINS                         ((FIT_APNEA_DISCIPLINE)1)
#define FIT_APNEA_DISCIPLINE_CONSTANT_WEIGHT_WITHOUT_FINS                        ((FIT_APNEA_DISCIPLINE)2)
#define FIT_APNEA_DISCIPLINE_DYNAMIC_WITH_FINS                                   ((FIT_APNEA_DISCIPLINE)3)
#define FIT_APNEA_DISCIPLINE_DYNAMIC_WITH_BIFINS                                 ((FIT_APNEA_DISCIPLINE)4)
#define FIT_APNEA_DISCIPLINE_DYNAMIC_WITHOUT_FINS                                ((FIT_APNEA_DISCIPLINE)5)
#define FIT_APNEA_DISCIPLINE_FREE_IMMERSION                                      ((FIT_APNEA_DISCIPLINE)6)
#define FIT_APNEA_DISCIPLINE_NO_LIMIT                                            ((FIT_APNEA_DISCIPLINE)7)
#define FIT_APNEA_DISCIPLINE_SPEED_ENDURANCE_APNEA                               ((FIT_APNEA_DISCIPLINE)8)
#define FIT_APNEA_DISCIPLINE_STATIC_APNEA                                        ((FIT_APNEA_DISCIPLINE)9)
#define FIT_APNEA_DISCIPLINE_VARIABLE_WEIGHT                                     ((FIT_APNEA_DISCIPLINE)10)
#define FIT_APNEA_DISCIPLINE_COUNT                                               11
...
public:
    ...
    typedef enum
    {
        ...
        SESSION_MESG_ACTIVE_TIME,
        SESSION_MESG_AVG_STROKES_PER_LENGTH,
        SESSION_MESG_AVG_SWOLF,
        ...
        SESSION_MESG_NUM_SEGMENT_LAPS,
        SESSION_MESG_FRONT_GEAR_SHIFT_COUNT,
        SESSION_MESG_REAR_GEAR_SHIFT_COUNT,
        ...
        SESSION_MESG_METABOLIC_CALORIES,
        ...
        SESSION_MESG_AVG_GRADE_ADJUSTED_SPEED,
        SESSION_MESG_FIELDS
    } SESSION_MESG_FIELD_INDEX;

    typedef enum
    {
        SESSION_MESG_TOTAL_CYCLES_FIELD_TOTAL_REPS,
        SESSION_MESG_TOTAL_CYCLES_FIELD_TOTAL_STRIDES,
        SESSION_MESG_TOTAL_CYCLES_FIELD_TOTAL_STROKES,
        SESSION_MESG_TOTAL_CYCLES_FIELD_TOTAL_PUSHES,
    ...
    typedef enum
    {
        ...
        SESSION_MESG_AVG_CADENCE_FIELD_AVG_SWIMMING_CADENCE,
        SESSION_MESG_AVG_CADENCE_FIELD_AVG_PADDLESPORT_CADENCE,
        SESSION_MESG_AVG_CADENCE_FIELD_AVG_PUSH_CADENCE,
    ...
    typedef enum
    {
        ...
        SESSION_MESG_MAX_CADENCE_FIELD_MAX_SWIMMING_CADENCE,
        SESSION_MESG_MAX_CADENCE_FIELD_MAX_PADDLESPORT_CADENCE,
        SESSION_MESG_MAX_CADENCE_FIELD_MAX_PUSH_CADENCE,
    ...
    typedef enum
    {
        ...
        LAP_MESG_AVG_STROKES_PER_LENGTH,
        ...
        LAP_MESG_FRONT_GEAR_SHIFT_COUNT,
        LAP_MESG_REAR_GEAR_SHIFT_COUNT,
        ...
        LAP_MESG_AVG_GRADE_ADJUSTED_SPEED,
        LAP_MESG_FIELDS
    ...
    typedef enum
    {
        ...
        LAP_MESG_TOTAL_CYCLES_FIELD_TOTAL_PUSHES,
    ...
    typedef enum
    {
        ...
        LAP_MESG_AVG_CADENCE_FIELD_AVG_SWIMMING_CADENCE,
        LAP_MESG_AVG_CADENCE_FIELD_AVG_PADDLESPORT_CADENCE,
        LAP_MESG_AVG_CADENCE_FIELD_AVG_PUSH_CADENCE,
    ...
    typedef enum
    {
        ...
        LAP_MESG_MAX_CADENCE_FIELD_MAX_SWIMMING_CADENCE,
        LAP_MESG_MAX_CADENCE_FIELD_MAX_PADDLESPORT_CADENCE,
        LAP_MESG_MAX_CADENCE_FIELD_MAX_PUSH_CADENCE,
    ...
    typedef enum
    {
        ...
        LENGTH_MESG_METABOLIC_CALORIES,
        LENGTH_MESG_FIELDS
    ...
    typedef enum
    {
        BATTERY_MESG_TIMESTAMP,
        BATTERY_MESG_CAPACITY,
        BATTERY_MESG_FIELDS
    } BATTERY_MESG_FIELD_INDEX;
    ...
    typedef enum
    {
        ...
        BAROMETER_DATA_MESG_ENHANCED_ALTITUDE,
    ...
    typedef enum
    {
        ...
        SPLIT_MESG_SPORT,
        SPLIT_MESG_SUB_SPORT,
        SPLIT_MESG_TOTAL_ASCENT,
        SPLIT_MESG_TOTAL_DESCENT,
        SPLIT_MESG_AVG_HEART_RATE,
        SPLIT_MESG_MAX_HEART_RATE,
        SPLIT_MESG_NEC_LAT,
        SPLIT_MESG_NEC_LONG,
        SPLIT_MESG_SWC_LAT,
        SPLIT_MESG_SWC_LONG,
        ...
        SPLIT_MESG_AVG_CADENCE,
        SPLIT_MESG_MAX_CADENCE,
        SPLIT_MESG_TOTAL_CYCLES,
        SPLIT_MESG_AVG_TEMPERATURE,
        SPLIT_MESG_MAX_TEMPERATURE,
        SPLIT_MESG_MIN_TEMPERATURE,
        SPLIT_MESG_AVG_VERTICAL_OSCILLATION,
        SPLIT_MESG_AVG_VERTICAL_RATIO,
        SPLIT_MESG_AVG_STANCE_TIME,
        SPLIT_MESG_AVG_STANCE_TIME_BALANCE,
        SPLIT_MESG_AVG_STEP_LENGTH,
        SPLIT_MESG_AVG_POWER,
        SPLIT_MESG_MAX_POWER,
        SPLIT_MESG_NORMALIZED_POWER,
        SPLIT_MESG_LEFT_RIGHT_BALANCE,
        SPLIT_MESG_TIME_STANDING,
        SPLIT_MESG_AVG_LEFT_PCO,
        SPLIT_MESG_AVG_RIGHT_PCO,
        SPLIT_MESG_AVG_LEFT_POWER_PHASE,
        SPLIT_MESG_AVG_LEFT_POWER_PHASE_PEAK,
        SPLIT_MESG_AVG_RIGHT_POWER_PHASE,
        SPLIT_MESG_AVG_RIGHT_POWER_PHASE_PEAK,
        SPLIT_MESG_AVG_POWER_POSITION,
        SPLIT_MESG_MAX_POWER_POSITION,
        SPLIT_MESG_AVG_LEFT_TORQUE_EFFECTIVENESS,
        SPLIT_MESG_AVG_RIGHT_TORQUE_EFFECTIVENESS,
        SPLIT_MESG_AVG_LEFT_PEDAL_SMOOTHNESS,
        SPLIT_MESG_AVG_RIGHT_PEDAL_SMOOTHNESS,
        SPLIT_MESG_AVG_COMBINED_PEDAL_SMOOTHNESS,
        SPLIT_MESG_AVG_FLOW,
        SPLIT_MESG_TOTAL_GRIT,
        SPLIT_MESG_SWIM_STROKE,
        SPLIT_MESG_NUM_ACTIVE_LENGTHS,
        SPLIT_MESG_AVG_SWOLF,
        SPLIT_MESG_AVG_STROKE_DISTANCE,
        SPLIT_MESG_AVG_STROKES_PER_LENGTH,
        SPLIT_MESG_FIRST_LAP_INDEX,
        SPLIT_MESG_NUM_LAPS,
        SPLIT_MESG_CLIMB_GRADING_SCALE,
        SPLIT_MESG_CLIMB_GRADE_VALUE,
        SPLIT_MESG_STATUS,
        SPLIT_MESG_NUM_FALLS,
        SPLIT_MESG_CLIMB_SEND,
        SPLIT_MESG_START_ELEVATION,
        SPLIT_MESG_ACTIVE_TIME,
        SPLIT_MESG_METABOLIC_CALORIES,
        SPLIT_MESG_TOTAL_FRACTIONAL_ASCENT,
        SPLIT_MESG_TOTAL_FRACTIONAL_DESCENT,
        SPLIT_MESG_AVG_GRADE,
        SPLIT_MESG_MAX_GRADE,
        SPLIT_MESG_MIN_CADENCE,
        SPLIT_MESG_AVG_GRADE_ADJUSTED_SPEED,
        SPLIT_MESG_AVG_STRESS,
        SPLIT_MESG_AVG_VAM,
        SPLIT_MESG_JUMP_COUNT,
        SPLIT_MESG_TOTAL_MOVING_TIME,
        SPLIT_MESG_DIVE_SECTION_TYPE,
        SPLIT_MESG_AVG_ASCENT_RATE,
        SPLIT_MESG_MAX_ASCENT_RATE,
        SPLIT_MESG_AVG_DESCENT_RATE,
        SPLIT_MESG_MAX_DESCENT_RATE,
        SPLIT_MESG_TOTAL_ASCENT_TIME,
        SPLIT_MESG_TOTAL_DESCENT_TIME,
        SPLIT_MESG_TOTAL_HANG_TIME,
        SPLIT_MESG_APNEA_DISCIPLINE,
        SPLIT_MESG_AVG_DEPTH,
        SPLIT_MESG_MAX_DEPTH,
        SPLIT_MESG_MIN_HEART_RATE,
        SPLIT_MESG_SURFACE_INTERVAL,
        SPLIT_MESG_TOTAL_FRACTIONAL_CYCLES,
        SPLIT_MESG_AVG_STANCE_TIME_PERCENT,
        SPLIT_MESG_TOTAL_ANAEROBIC_TRAINING_EFFECT,
        SPLIT_MESG_FRONT_GEAR_SHIFT_COUNT,
        SPLIT_MESG_REAR_GEAR_SHIFT_COUNT,
        SPLIT_MESG_FIELDS
    } SPLIT_MESG_FIELD_INDEX;

    typedef enum
    {
        SPLIT_MESG_AVG_CADENCE_FIELD_AVG_RUNNING_CADENCE,
        SPLIT_MESG_AVG_CADENCE_FIELD_AVG_SWIMMING_CADENCE,
        SPLIT_MESG_AVG_CADENCE_FIELD_AVG_PADDLESPORT_CADENCE,
        SPLIT_MESG_AVG_CADENCE_FIELD_AVG_PUSH_CADENCE,
        SPLIT_MESG_AVG_CADENCE_FIELD_SUBFIELDS,
        SPLIT_MESG_AVG_CADENCE_FIELD_ACTIVE_SUBFIELD = FIT_SUBFIELD_INDEX_ACTIVE_SUBFIELD,
        SPLIT_MESG_AVG_CADENCE_FIELD_MAIN_FIELD = FIT_SUBFIELD_INDEX_MAIN_FIELD
    } SPLIT_MESG_AVG_CADENCE_FIELD_SUBFIELD_INDEX;

    typedef enum
    {
        SPLIT_MESG_MAX_CADENCE_FIELD_MAX_RUNNING_CADENCE,
        SPLIT_MESG_MAX_CADENCE_FIELD_MAX_SWIMMING_CADENCE,
        SPLIT_MESG_MAX_CADENCE_FIELD_MAX_PADDLESPORT_CADENCE,
        SPLIT_MESG_MAX_CADENCE_FIELD_MAX_PUSH_CADENCE,
        SPLIT_MESG_MAX_CADENCE_FIELD_SUBFIELDS,
        SPLIT_MESG_MAX_CADENCE_FIELD_ACTIVE_SUBFIELD = FIT_SUBFIELD_INDEX_ACTIVE_SUBFIELD,
        SPLIT_MESG_MAX_CADENCE_FIELD_MAIN_FIELD = FIT_SUBFIELD_INDEX_MAIN_FIELD
    } SPLIT_MESG_MAX_CADENCE_FIELD_SUBFIELD_INDEX;

    typedef enum
    {
        SPLIT_MESG_TOTAL_CYCLES_FIELD_TOTAL_STRIDES,
        SPLIT_MESG_TOTAL_CYCLES_FIELD_TOTAL_STROKES,
        SPLIT_MESG_TOTAL_CYCLES_FIELD_TOTAL_REPS,
        SPLIT_MESG_TOTAL_CYCLES_FIELD_TOTAL_PUSHES,
        SPLIT_MESG_TOTAL_CYCLES_FIELD_SUBFIELDS,
        SPLIT_MESG_TOTAL_CYCLES_FIELD_ACTIVE_SUBFIELD = FIT_SUBFIELD_INDEX_ACTIVE_SUBFIELD,
        SPLIT_MESG_TOTAL_CYCLES_FIELD_MAIN_FIELD = FIT_SUBFIELD_INDEX_MAIN_FIELD
    } SPLIT_MESG_TOTAL_CYCLES_FIELD_SUBFIELD_INDEX;

    typedef enum
    {
        SPLIT_MESG_CLIMB_GRADE_VALUE_FIELD_CLIMB_GRADE_YDS,
        SPLIT_MESG_CLIMB_GRADE_VALUE_FIELD_CLIMB_GRADE_UIAA,
        SPLIT_MESG_CLIMB_GRADE_VALUE_FIELD_CLIMB_GRADE_FRENCH,
        SPLIT_MESG_CLIMB_GRADE_VALUE_FIELD_CLIMB_GRADE_BRITISH_ADJECTIVAL,
        SPLIT_MESG_CLIMB_GRADE_VALUE_FIELD_CLIMB_GRADE_BRITISH_TECHNICAL,
        SPLIT_MESG_CLIMB_GRADE_VALUE_FIELD_CLIMB_GRADE_EWBANK,
        SPLIT_MESG_CLIMB_GRADE_VALUE_FIELD_CLIMB_GRADE_BRAZILIAN,
        SPLIT_MESG_CLIMB_GRADE_VALUE_FIELD_CLIMB_GRADE_SAXON,
        SPLIT_MESG_CLIMB_GRADE_VALUE_FIELD_CLIMB_GRADE_VERMIN,
        SPLIT_MESG_CLIMB_GRADE_VALUE_FIELD_CLIMB_GRADE_FONT,
        SPLIT_MESG_CLIMB_GRADE_VALUE_FIELD_CLIMB_GRADE_DANKYU,
        SPLIT_MESG_CLIMB_GRADE_VALUE_FIELD_SUBFIELDS,
        SPLIT_MESG_CLIMB_GRADE_VALUE_FIELD_ACTIVE_SUBFIELD = FIT_SUBFIELD_INDEX_ACTIVE_SUBFIELD,
        SPLIT_MESG_CLIMB_GRADE_VALUE_FIELD_MAIN_FIELD = FIT_SUBFIELD_INDEX_MAIN_FIELD
    } SPLIT_MESG_CLIMB_GRADE_VALUE_FIELD_SUBFIELD_INDEX;

    typedef enum
    {
        SPLIT_MESG_MIN_CADENCE_FIELD_MIN_RUNNING_CADENCE,
        SPLIT_MESG_MIN_CADENCE_FIELD_MIN_SWIMMING_CADENCE,
        SPLIT_MESG_MIN_CADENCE_FIELD_MIN_PADDLESPORT_CADENCE,
        SPLIT_MESG_MIN_CADENCE_FIELD_MIN_PUSH_CADENCE,
        SPLIT_MESG_MIN_CADENCE_FIELD_SUBFIELDS,
        SPLIT_MESG_MIN_CADENCE_FIELD_ACTIVE_SUBFIELD = FIT_SUBFIELD_INDEX_ACTIVE_SUBFIELD,
        SPLIT_MESG_MIN_CADENCE_FIELD_MAIN_FIELD = FIT_SUBFIELD_INDEX_MAIN_FIELD
    } SPLIT_MESG_MIN_CADENCE_FIELD_SUBFIELD_INDEX;

    typedef enum
    {
        SPLIT_SUMMARY_MESG_MESSAGE_INDEX,
        SPLIT_SUMMARY_MESG_TIMESTAMP,
        SPLIT_SUMMARY_MESG_SPLIT_TYPE,
        SPLIT_SUMMARY_MESG_SPORT,
        SPLIT_SUMMARY_MESG_SUB_SPORT,
        ...
        SPLIT_SUMMARY_MESG_AVG_CADENCE,
        SPLIT_SUMMARY_MESG_MAX_CADENCE,
        SPLIT_SUMMARY_MESG_TOTAL_CYCLES,
        SPLIT_SUMMARY_MESG_AVG_TEMPERATURE,
        SPLIT_SUMMARY_MESG_MAX_TEMPERATURE,
        SPLIT_SUMMARY_MESG_MIN_TEMPERATURE,
        SPLIT_SUMMARY_MESG_AVG_VERTICAL_OSCILLATION,
        SPLIT_SUMMARY_MESG_AVG_VERTICAL_RATIO,
        SPLIT_SUMMARY_MESG_AVG_STANCE_TIME,
        SPLIT_SUMMARY_MESG_AVG_STANCE_TIME_BALANCE,
        SPLIT_SUMMARY_MESG_AVG_STEP_LENGTH,
        SPLIT_SUMMARY_MESG_AVG_POWER,
        SPLIT_SUMMARY_MESG_MAX_POWER,
        SPLIT_SUMMARY_MESG_NORMALIZED_POWER,
        SPLIT_SUMMARY_MESG_LEFT_RIGHT_BALANCE,
        SPLIT_SUMMARY_MESG_TIME_STANDING,
        SPLIT_SUMMARY_MESG_AVG_LEFT_PCO,
        SPLIT_SUMMARY_MESG_AVG_RIGHT_PCO,
        SPLIT_SUMMARY_MESG_AVG_LEFT_POWER_PHASE,
        SPLIT_SUMMARY_MESG_AVG_LEFT_POWER_PHASE_PEAK,
        SPLIT_SUMMARY_MESG_AVG_RIGHT_POWER_PHASE,
        SPLIT_SUMMARY_MESG_AVG_RIGHT_POWER_PHASE_PEAK,
        SPLIT_SUMMARY_MESG_AVG_POWER_POSITION,
        SPLIT_SUMMARY_MESG_MAX_POWER_POSITION,
        SPLIT_SUMMARY_MESG_AVG_LEFT_TORQUE_EFFECTIVENESS,
        SPLIT_SUMMARY_MESG_AVG_RIGHT_TORQUE_EFFECTIVENESS,
        SPLIT_SUMMARY_MESG_AVG_LEFT_PEDAL_SMOOTHNESS,
        SPLIT_SUMMARY_MESG_AVG_RIGHT_PEDAL_SMOOTHNESS,
        SPLIT_SUMMARY_MESG_AVG_COMBINED_PEDAL_SMOOTHNESS,
        SPLIT_SUMMARY_MESG_AVG_FLOW,
        SPLIT_SUMMARY_MESG_TOTAL_GRIT,
        SPLIT_SUMMARY_MESG_SWIM_STROKE,
        SPLIT_SUMMARY_MESG_NUM_ACTIVE_LENGTHS,
        SPLIT_SUMMARY_MESG_AVG_SWOLF,
        SPLIT_SUMMARY_MESG_AVG_STROKE_DISTANCE,
        SPLIT_SUMMARY_MESG_AVG_STROKES_PER_LENGTH,
        SPLIT_SUMMARY_MESG_AVG_ASCENT,
        SPLIT_SUMMARY_MESG_MAX_ASCENT,
        SPLIT_SUMMARY_MESG_CLIMB_GRADING_SCALE,
        SPLIT_SUMMARY_MESG_CLIMB_MAX_GRADE_VALUE,
        SPLIT_SUMMARY_MESG_NUM_FALLS,
        SPLIT_SUMMARY_MESG_NUM_CLIMBS_ATTEMPTED,
        SPLIT_SUMMARY_MESG_NUM_CLIMBS_COMPLETED,
        SPLIT_SUMMARY_MESG_MAX_DISTANCE,
        SPLIT_SUMMARY_MESG_METABOLIC_CALORIES,
        SPLIT_SUMMARY_MESG_ACTIVE_TIME,
        SPLIT_SUMMARY_MESG_TOTAL_FRACTIONAL_ASCENT,
        SPLIT_SUMMARY_MESG_TOTAL_FRACTIONAL_DESCENT,
        SPLIT_SUMMARY_MESG_AVG_FRACTIONAL_ASCENT,
        SPLIT_SUMMARY_MESG_MAX_FRACTIONAL_ASCENT,
        SPLIT_SUMMARY_MESG_AVG_GRADE_ADJUSTED_SPEED,
        SPLIT_SUMMARY_MESG_AVG_STRESS,
        SPLIT_SUMMARY_MESG_TOTAL_MOVING_TIME,
        SPLIT_SUMMARY_MESG_START_TIME,
        SPLIT_SUMMARY_MESG_MIN_HEART_RATE,
        SPLIT_SUMMARY_MESG_AVG_STANCE_TIME_PERCENT,
        SPLIT_SUMMARY_MESG_MAX_TOTAL_TIMER_TIME,
        SPLIT_SUMMARY_MESG_FIELDS
    } SPLIT_SUMMARY_MESG_FIELD_INDEX;

    typedef enum
    {
        SPLIT_SUMMARY_MESG_AVG_CADENCE_FIELD_AVG_RUNNING_CADENCE,
        SPLIT_SUMMARY_MESG_AVG_CADENCE_FIELD_AVG_SWIMMING_CADENCE,
        SPLIT_SUMMARY_MESG_AVG_CADENCE_FIELD_AVG_PADDLESPORT_CADENCE,
        SPLIT_SUMMARY_MESG_AVG_CADENCE_FIELD_AVG_PUSH_CADENCE,
        SPLIT_SUMMARY_MESG_AVG_CADENCE_FIELD_SUBFIELDS,
        SPLIT_SUMMARY_MESG_AVG_CADENCE_FIELD_ACTIVE_SUBFIELD = FIT_SUBFIELD_INDEX_ACTIVE_SUBFIELD,
        SPLIT_SUMMARY_MESG_AVG_CADENCE_FIELD_MAIN_FIELD = FIT_SUBFIELD_INDEX_MAIN_FIELD
    } SPLIT_SUMMARY_MESG_AVG_CADENCE_FIELD_SUBFIELD_INDEX;

    typedef enum
    {
        SPLIT_SUMMARY_MESG_MAX_CADENCE_FIELD_MAX_RUNNING_CADENCE,
        SPLIT_SUMMARY_MESG_MAX_CADENCE_FIELD_MAX_SWIMMING_CADENCE,
        SPLIT_SUMMARY_MESG_MAX_CADENCE_FIELD_MAX_PADDLESPORT_CADENCE,
        SPLIT_SUMMARY_MESG_MAX_CADENCE_FIELD_MAX_PUSH_CADENCE,
        SPLIT_SUMMARY_MESG_MAX_CADENCE_FIELD_SUBFIELDS,
        SPLIT_SUMMARY_MESG_MAX_CADENCE_FIELD_ACTIVE_SUBFIELD = FIT_SUBFIELD_INDEX_ACTIVE_SUBFIELD,
        SPLIT_SUMMARY_MESG_MAX_CADENCE_FIELD_MAIN_FIELD = FIT_SUBFIELD_INDEX_MAIN_FIELD
    } SPLIT_SUMMARY_MESG_MAX_CADENCE_FIELD_SUBFIELD_INDEX;

    typedef enum
    {
        SPLIT_SUMMARY_MESG_TOTAL_CYCLES_FIELD_TOTAL_STRIDES,
        SPLIT_SUMMARY_MESG_TOTAL_CYCLES_FIELD_TOTAL_STROKES,
        SPLIT_SUMMARY_MESG_TOTAL_CYCLES_FIELD_TOTAL_REPS,
        SPLIT_SUMMARY_MESG_TOTAL_CYCLES_FIELD_TOTAL_PUSHES,
        SPLIT_SUMMARY_MESG_TOTAL_CYCLES_FIELD_SUBFIELDS,
        SPLIT_SUMMARY_MESG_TOTAL_CYCLES_FIELD_ACTIVE_SUBFIELD = FIT_SUBFIELD_INDEX_ACTIVE_SUBFIELD,
        SPLIT_SUMMARY_MESG_TOTAL_CYCLES_FIELD_MAIN_FIELD = FIT_SUBFIELD_INDEX_MAIN_FIELD
    } SPLIT_SUMMARY_MESG_TOTAL_CYCLES_FIELD_SUBFIELD_INDEX;

    typedef enum
    {
        SPLIT_SUMMARY_MESG_CLIMB_MAX_GRADE_VALUE_FIELD_CLIMB_MAX_GRADE_YDS,
        SPLIT_SUMMARY_MESG_CLIMB_MAX_GRADE_VALUE_FIELD_CLIMB_MAX_GRADE_UIAA,
        SPLIT_SUMMARY_MESG_CLIMB_MAX_GRADE_VALUE_FIELD_CLIMB_MAX_GRADE_FRENCH,
        SPLIT_SUMMARY_MESG_CLIMB_MAX_GRADE_VALUE_FIELD_CLIMB_MAX_GRADE_BRITISH_ADJECTIVAL,
        SPLIT_SUMMARY_MESG_CLIMB_MAX_GRADE_VALUE_FIELD_CLIMB_MAX_GRADE_BRITISH_TECHNICAL,
        SPLIT_SUMMARY_MESG_CLIMB_MAX_GRADE_VALUE_FIELD_CLIMB_MAX_GRADE_EWBANK,
        SPLIT_SUMMARY_MESG_CLIMB_MAX_GRADE_VALUE_FIELD_CLIMB_MAX_GRADE_BRAZILIAN,
        SPLIT_SUMMARY_MESG_CLIMB_MAX_GRADE_VALUE_FIELD_CLIMB_MAX_GRADE_SAXON,
        SPLIT_SUMMARY_MESG_CLIMB_MAX_GRADE_VALUE_FIELD_CLIMB_MAX_GRADE_VERMIN,
        SPLIT_SUMMARY_MESG_CLIMB_MAX_GRADE_VALUE_FIELD_CLIMB_MAX_GRADE_FONT,
        SPLIT_SUMMARY_MESG_CLIMB_MAX_GRADE_VALUE_FIELD_CLIMB_MAX_GRADE_DANKYU,
        SPLIT_SUMMARY_MESG_CLIMB_MAX_GRADE_VALUE_FIELD_SUBFIELDS,
        SPLIT_SUMMARY_MESG_CLIMB_MAX_GRADE_VALUE_FIELD_ACTIVE_SUBFIELD = FIT_SUBFIELD_INDEX_ACTIVE_SUBFIELD,
        SPLIT_SUMMARY_MESG_CLIMB_MAX_GRADE_VALUE_FIELD_MAIN_FIELD = FIT_SUBFIELD_INDEX_MAIN_FIELD
    } SPLIT_SUMMARY_MESG_CLIMB_MAX_GRADE_VALUE_FIELD_SUBFIELD_INDEX;
    ...
    typedef enum
    {
        ...
        SEGMENT_LAP_MESG_METABOLIC_CALORIES,
    ...
    typedef enum
    {
        NAP_EVENT_MESG_MESSAGE_INDEX,
        NAP_EVENT_MESG_TIMESTAMP,
        NAP_EVENT_MESG_START_TIME,
        NAP_EVENT_MESG_START_TIMEZONE_OFFSET,
        NAP_EVENT_MESG_END_TIME,
        NAP_EVENT_MESG_END_TIMEZONE_OFFSET,
        NAP_EVENT_MESG_FEEDBACK,
        NAP_EVENT_MESG_IS_DELETED,
        NAP_EVENT_MESG_SOURCE,
        NAP_EVENT_MESG_UPDATE_TIMESTAMP,
        NAP_EVENT_MESG_FIELDS
    } NAP_EVENT_MESG_FIELD_INDEX;
