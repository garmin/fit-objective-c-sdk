...
namespace fit
{
    ...
    FIT_UINT64 Accumulator::Accumulate(const FIT_UINT16 mesgNum, const FIT_UINT8 destFieldNum, const FIT_UINT64 value, const FIT_UINT8 bits)
    {
        int i;
    ...
    void Accumulator::Set(const FIT_UINT16 mesgNum, const FIT_UINT8 destFieldNum, const FIT_UINT64 value)
    {
        int i;
        AccumulatedField accumField;
